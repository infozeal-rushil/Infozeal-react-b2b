...
import comingSoonLight from '@src/assets/img/animated-icons/coming-soon-light.json';
import comingSoonDark from '@src/assets/img/animated-icons/coming-soon-dark.json';
import comingSoonText from '@src/assets/img/spot-illustrations/40.png';
import comingSoonTextDark from '@src/assets/img/spot-illustrations/dark_40.png';
