...
const CalendarTop = () => {
    ...
    return (<Row className="g-0 mb-4 align-items-center">
      <Col xs={5} md={6}>
      ...
      <Col xs={7} md={6} className="d-flex justify-content-end">
        <Button variant="link" className="text-body px-0 me-2 me-md-4" startIcon={<FontAwesomeIcon icon={faSync} className="fs-10 me-2"/>}>
        ...
        }} variant="primary" size="sm" startIcon={<FontAwesomeIcon icon={faPlus} className="fs-10 me-2"/>}>
          Add new task
        </Button>
      </Col>
    </Row>);
