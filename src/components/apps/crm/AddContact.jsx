...
import AvatarUpload from '@globals/g-components/common/AvatarUpload';
...
import avatar from '@src/assets/img/team/150x150/58.webp';
import { Col, FloatingLabel, Form, Row } from 'react-bootstrap';
import LeadInformationForm from '@globals/g-components/forms/LeadInformationForm';
import AddressInformation from '@globals/g-components/forms/AddressInformation';
const AddContact = () => {
  return (
    <div className="mb-9">
