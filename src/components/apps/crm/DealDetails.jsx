...
import DealProfileCard from '@globals/g-components/cards/DealProfileCard';
import DealsPrintingDimensionsCard from '@globals/g-components/cards/DealsPrintingDimensionsCard';
import PageBreadcrumb from '@globals/g-components/common/PageBreadcrumb';
import DealsOtherInformation from '@globals/g-components/forms/DealsOtherInformation';
import DealDetailsInfo from '@globals/g-components/modules/crm/deals-details/DealDetailsInfo';
import DealDetailsTab from '@globals/g-components/modules/crm/deals-details/DealDetailsTab';
import { defaultBreadcrumbItems } from '@globals/g-data/commonData';
import { dealDetailsInfoData, stats } from '@globals/g-data/crm/dealDetailsInfo';
      ...
      <div className="mb-9">
        <Row className="align-items-center justify-content-between g-3 mb-4">
          ...
          <Col md="auto" className="d-flex">
            ...
            <Button variant="phoenix-danger" className="me-2" startIcon={<FontAwesomeIcon icon={faTrash} className="me-2"/>}>
              <span>Delete Deal</span>
            </Button>
            <Dropdown>
              <Dropdown.Toggle variant="phoenix-secondary" className="px-3 dropdown-caret-none">
