...
import OrganizeFormCard from '@globals/g-components/cards/OrganizeFormCard';
import VariantFormCard from '@globals/g-components/cards/VariantFormCard';
import PageBreadcrumb from '@globals/g-components/common/PageBreadcrumb';
import InventoryTab from '@globals/g-components/tabs/InventoryTab';
        ...
        <Row className="g-5">
          <Col xs={12} xl={8}>
            ...
            <div className="mb-5">
              ...
              <Dropzone className="mb-3" accept={{
