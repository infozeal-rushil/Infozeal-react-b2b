...
import StoreItem from '@globals/g-components/common/StoreItem';
import { defaultBreadcrumbItems } from '@globals/g-data/commonData';
import { stores } from '@globals/g-data/e-commerce/stores';
    ...
    return (<div className="pt-5 mb-9">
      <Section small className="py-0">
        ...
        <Row className="gx-3 gy-5">
          {stores.map(store => (<Col key={store.name} xs={6} sm={4} md={3} lg={2}>
