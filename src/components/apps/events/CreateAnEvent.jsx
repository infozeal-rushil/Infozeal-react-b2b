...
import EventCustomFields from '@globals/g-components/forms/EventCustomFields';
import EventDescriptionForm from '@globals/g-components/forms/EventDescriptionForm';
import EventDetailsForm from '@globals/g-components/forms/EventDetailsForm';
import EventTicketPricing from '@globals/g-components/forms/EventTicketPricing';
import EventsSchedule from '@globals/g-components/forms/EventsSchedule';
        ...
        <Row className="justify-content-between align-items-end g-3 mb-5">
          ...
          <Col xs={12} sm="auto" xl={4}>
            <div className="d-flex">
              <Button className="px-5 me-2" variant="phoenix-primary" type="button">
                Save
              </Button>
              <Button variant="primary" as={Link} to="/apps/events/event-details" className="px-5 w-100 text-nowrap">
                Publish Event
              </Button>
            </div>
          </Col>
          ...
          <Col xl={4}>
            <div className="border-bottom border-translucent pb-6 mb-6">
              ...
              <Form.Check type="radio" id="privacy1" className="mb-2">
                <Form.Check.Input type="radio" name="vrivacyRadio" value="option1" defaultChecked/>
              ...
              <Form.Check type="radio" id="privacy2" className="mb-0">
                <Form.Check.Input type="radio" name="vrivacyRadio" value="option1"/>
            ...
            <div className="border-bottom border-translucent mb-6">
              <Form.Check type="checkbox" id="flexChecked">
                <Form.Check.Input type="checkbox" value="option1" defaultChecked/>
                <Form.Check.Label className="fw-bold fs-8 mb-5" htmlFor="flexChecked">
