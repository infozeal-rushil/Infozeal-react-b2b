...
import coverImg from '@src/assets/img/generic/34.png';
import { Col, Row } from 'react-bootstrap';
import EventTitleCard from '@globals/g-components/cards/EventTitleCard';
import ResponsesAndShare from '@globals/g-components/modules/events/ResponsesAndShare';
import Location from '@globals/g-components/modules/events/Location';
import Badge from '@globals/g-components/base/Badge';
import Events from '@globals/g-components/modules/events/Events';
import EventsSingersSection from '@globals/g-components/modules/events/EventsSingersSection';
import EventsTopicCovered from '@globals/g-components/list-items/EventsTopicCovered';
import EventsOrganized from '@globals/g-components/modules/events/EventsOrganized';
import { SingerPhotos, events } from '@globals/g-data/eventsData';
const EventDetail = () => {
  return (
    <div className="pb-9">
