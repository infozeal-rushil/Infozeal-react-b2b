...
import boardIcon from '@src/assets/img/kanban/board.png';
import boardIllustration from '@src/assets/img/kanban/board-light.png';
import boardIllustrationDark from '@src/assets/img/kanban/board-dark.png';
import CreateBoardWizardForm from '@globals/g-components/modules/kanban/create-board/CreateBoardWizardForm';
const CreateBoard = () => {
  return (
    <div className="mb-9">
