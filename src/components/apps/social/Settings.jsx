...
import SettingsChangePassword from '@globals/g-components/forms/SettingsChangePassword';
import SettingsCompanyInfo from '@globals/g-components/forms/SettingsCompanyInfo';
import SettingsPersonalInfo from '@globals/g-components/forms/SettingsPersonalInfo';
import SettingsSocial from '@globals/g-components/forms/SettingsSocial';
import SocialSettingsSideBar from '@globals/g-components/modules/social/SocialSettingsSideBar';
import { Col, Row } from 'react-bootstrap';
import profileImage from '@src/assets/img/team/20.webp';
const Settings = () => {
  return (
    <div className="mb-9">
      <Row className="g-6">
