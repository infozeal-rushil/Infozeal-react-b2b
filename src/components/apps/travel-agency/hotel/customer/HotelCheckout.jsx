...
import HotelDetailsSummaryCard from '@globals/g-components/cards/HotelDetailsSummaryCard';
          ...
          <Row className="justify-content-between">
            <Col lg={7} xl={6}>
              <Form id="checkoutForm1" onSubmit={e => e.preventDefault()}>
                ...
                <Form.Check id="tripTypeRadio" className="form-check-inline me-4">
                  <Form.Check.Input type="radio" name="tripTypeRadio" value="no" defaultChecked/>
                  <Form.Check.Label htmlFor="tripTypeRadio">
                    No
                  </Form.Check.Label>
                </Form.Check>
                <Form.Check id="tripTypeRadio" className="form-check-inline">
                  <Form.Check.Input type="radio" name="tripTypeRadio" value="yes"/>
                  <Form.Check.Label htmlFor="tripTypeRadio">
                    Yes
                  </Form.Check.Label>
                </Form.Check>
                <Row className="g-3 mb-5 mt-1">
                  <Col sm={6}>
                    <label htmlFor="first-name" className="fw-bold text-body-highlight mb-1">
                      First name
                    </label>
                    <Form.Control type="text" id="first-name" placeholder="First name"/>
                  </Col>
                  <Col sm={6}>
                    <label htmlFor="last-name" className="fw-bold text-body-highlight mb-1">
                      Last name
                    </label>
                ...
                <Row className="g-3">
                  <Col sm={6}>
                    <label htmlFor="email-address" className="fw-bold text-body-highlight mb-1">
                      Email address
                    </label>
                    <Form.Control type="email" id="email-address" placeholder="Email address"/>
                  </Col>
                  <Col sm={6}>
                    <label htmlFor="confirm-email-address" className="fw-bold text-body-highlight mb-1">
                      Confirm email address
                    </label>
                    <Form.Control type="text" id="confirm-email-address" placeholder="Confirm email address "/>
                  </Col>
                </Row>
                <h5 className="mb-3 mt-7">Who are you booking for?</h5>
                <Form.Check id="bookingPersonRadio" className="form-check-inline me-4">
                  <Form.Check.Input type="radio" name="bookingPersonRadio" id="me" value="no" defaultChecked/>
                  <Form.Check.Label htmlFor="me">
                    I am the main guest
                  </Form.Check.Label>
                </Form.Check>
                <Form.Check id="bookingPersonRadio" className="form-check-inline">
                  <Form.Check.Input type="radio" name="bookingPersonRadio" value="yes" id="else"/>
                ...
                <Form.Check className="mb-4">
                  ...
                  <Form.Check.Label htmlFor="airportShuttle" className="fw-normal fs-8 text-body">
                ...
                <Form.Check>
                  ...
                  <Form.Check.Label htmlFor="rentingCar" className="fw-normal fs-8 text-body">
                ...
                <p className="mb-2">
                  <FontAwesomeIcon icon={faCircle} className="text-body-quaternary fs-10 me-2" transform="up-2"/>
                  No smoking
                </p>
                <p>
                  <FontAwesomeIcon icon={faCircle} className="text-body-quaternary fs-10 me-2" transform="up-2"/>
                ...
                <Form.Control as="textarea" name="requestText" rows={5} id="requestText" placeholder="Type your request"/>
                <hr className="mt-7 mb-5"/>
                <Link to="/apps/travel-agency/hotel/customer/payment">
                  <Button variant="primary" endIcon={<FontAwesomeIcon icon={faChevronRight} className="ms-2" transform="shrink-3"/>}>
                    Final details
                  </Button>
                </Link>
              </Form>
            ...
            <Col lg={5} xl={4}>
              <HotelDetailsSummaryCard showHotelInfo={true} className="mt-5 mt-lg-0"/>
            </Col>
          </Row>
        </Container>
      </section>
