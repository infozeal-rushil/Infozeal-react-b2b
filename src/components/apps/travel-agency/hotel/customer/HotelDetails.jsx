...
import { faEnvelope, faMap, faMapMarkerAlt, faPhone } from '@fortawesome/free-solid-svg-icons';
import HotelDetailsSummaryCard from '@globals/g-components/cards/HotelDetailsSummaryCard';
import { hotelImages } from '@globals/g-data/travel-agency/customer/hotelDetails';
import HotelDetailsTab from '@globals/g-components/modules/travel-agency/hotel/hotel-details/HotelDetailsTab';
import HotelDetailsGallery from '@globals/g-components/image-gallery/HotelDetailsGallery';
import { numberFormat } from '@globals/g-helpers/utils';
        ...
        <Container fluid="medium">
          ...
          <Row className="g-4 flex-between-end mb-5">
            <Col md={8} lg={9}>
              ...
              <div className="mb-1">
                <Link className="text-body-tertiary" to="#!">
                  <FontAwesomeIcon icon={faMapMarkerAlt} className="me-2 text-body"/>
              ...
              <div className="mb-1">
                <Link className="text-body-tertiary" to="mailto:sales.dhaka@radisson.com">
                  <FontAwesomeIcon icon={faEnvelope} className="me-2 text-body" transform="down-1"/>
            ...
            maximumFractionDigits: 1
                ...
                <Button variant="phoenix-primary" className="px-5 px-lg-8 w-100 w-md-auto" startIcon={<FontAwesomeIcon icon={faMap} className="me-2"/>}>
                  Show in map
                </Button>
              </div>
            </Col>
          ...
          <Row className="g-3">
            ...
            <Col xl={4}>
              <HotelDetailsSummaryCard showHotelInfo={false} className="mt-3 mt-xl-0"/>
            </Col>
          </Row>
        </Container>
      </section>
