...
import HotelCard from '@globals/g-components/cards/HotelCard';
import { hotels } from '@globals/g-data/travel-agency/customer/hotel';
...
import HomepageFilterOffcanvas from '@globals/g-components/modules/travel-agency/hotel/HomepageFilterOffcanvas';
const HotelHomepage = () => {
      ...
      <section className="container-medium py-0">
        <div className="py-6">
          <div className="d-flex">
            ...
            <Button variant="phoenix-secondary" className="text-nowrap px-3 px-md-4 ms-auto me-2">
              <FontAwesomeIcon icon={faMap} className="me-md-2"/>
              <span className="d-none d-md-inline-block">Show in map</span>
            </Button>
            <Button variant="phoenix-secondary" className="text-nowrap px-3" onClick={() => setIsOpen(true)}>
        ...
        <Row className="g-3 mb-6">
          {hotels.map((hotelInfo, index) => (<Col key={index} sm={6} lg={4} xl={3}>
