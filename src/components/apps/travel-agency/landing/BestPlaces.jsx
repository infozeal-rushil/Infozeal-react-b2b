...
import bgLeft28 from '@src/assets/img/bg/bg-left-28.png';
import bgRight28 from '@src/assets/img/bg/bg-right-28.png';
...
import { placesData } from '@globals/g-data/travel-agency/landing';
const BestPlaces = () => {
