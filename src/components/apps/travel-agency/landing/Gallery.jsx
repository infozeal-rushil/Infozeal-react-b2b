import bgLeft30 from '@src/assets/img/bg/bg-left-30.png';
import bgRight30 from '@src/assets/img/bg/bg-right-30.png';
import IsotopeNav from '@globals/g-components/navs/IsotopeNav';
...
import { galleryItems } from '@globals/g-data/travel-agency/landing';
const navItems = [
  {
    eventKey: 'tokyo',
    label: 'Tokyo'
