import bgLeft33 from '@src/assets/img/bg/bg-left-33.png';
import bgRight33 from '@src/assets/img/bg/bg-right-33.png';
import iPhone from '@src/assets/img/spot-illustrations/i-phone.png';
import iPhoneDark from '@src/assets/img/spot-illustrations/i-phone-dark.png';
import spotIllustration41 from '@src/assets/img/spot-illustrations/41.png';
import spotIllustrationDark41 from '@src/assets/img/spot-illustrations/dark_41.png';
import { Col, Row } from 'react-bootstrap';
import { Link } from 'react-router-dom';
import playStore from '@src/assets/img/generic/play-store.png';
import appStore from '@src/assets/img/generic/app-store.png';
const GetApp = () => {
  return (
