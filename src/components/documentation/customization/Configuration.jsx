...
const Configuration = () => {
    return (<div>
      <DocPageHeader title="Setting up configuration" description="Phoenix-React has a global configuration system. You can change the theme settings with a single global javascript object."/>
