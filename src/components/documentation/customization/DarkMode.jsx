...
import ThemeToggler from '@globals/g-components/common/ThemeToggler';
import PhoenixDocProvider from '@globals/g-providers/PhoenixDocProvider';
import ThemeDropdown from '@globals/g-components/docs/ThemeDropdown';
    ...
    return (<div>
      ...
      <DocPagesLayout>
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Toggle Dark Mode" description={`Toggling dark mode is very easy in ${import.meta.env.VITE_TITLE}-React. You can toggle dark or light mode by using checkbox, radio input, switch input and custom icon component.`}/>
          <PhoenixDocCard.Body code={darkModeExampleCode} noInline scope={{ FeatherIcon, useAppContext, ThemeToggler, ThemeDropdown }}/>
        </PhoenixDocCard>
