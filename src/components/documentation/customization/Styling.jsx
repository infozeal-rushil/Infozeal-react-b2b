...
const Styling = () => {
    return (<div>
      <DocPageHeader title="Styling" description="We recommend you customize your theme styles using the user style files. You can customize the theme’s styles with the following approaches:"/>
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body className="text-body-secondary">
            ...
            <p>
              Light mode is default theme style in {import.meta.env.VITE_TITLE}.
            ...
            <p>
              ...
              any <strong>{import.meta.env.VITE_TITLE} </strong>color to
