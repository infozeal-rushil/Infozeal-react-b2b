import bg from '@src/assets/img/bg/bg-40.png';
import bgDark from '@src/assets/img/bg/bg-dark-40.png';
...
import CategoryTab from '@globals/g-components/modules/faq/CategoryTab';
import SubCategoryTab from '@globals/g-components/modules/faq/SubCategoryTab';
import SubCategoryContent from '@globals/g-components/modules/faq/SubCategoryContent';
import FaqTabProvider, {
  useFaqTabContext
} from '@globals/g-providers/FaqTabProvider';
import CategoryOffcanvas from '@globals/g-components/modules/faq/CategoryOffcanvas';
const index = () => {
  return (
    <FaqTabProvider>
      <FaqTab />
