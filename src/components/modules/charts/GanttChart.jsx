...
import BasicGanttChart from '@globals/g-components/charts/dhtmlx/example/BasicGanttChart';
...
const GanttChart = () => {
    return (<div className="mb-9">
      <DocPageHeader title="Gantt chart" description="DHTMLX Gantt is the most complete Gantt chart library to cover all the needs of a project management app and advance web development." link={{
      ...
      <DocPagesLayout>
        <PhoenixDocCard>
          ...
          <PhoenixDocCard.Body className="gantt-chart-example" code={basicGanttChartCode} hidePreview>
            <BasicGanttChart />
          </PhoenixDocCard.Body>
        </PhoenixDocCard>
      </DocPagesLayout>
