...
const AccordionExample = () => {
    return (<div>
      <DocPageHeader title="Accordion" description="Build vertically collapsing accordions in combination with the Collapse component" link={{
            text: 'Accordion on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/accordion/`
        }}/>
