...
const AlertsExample = () => {
    return (<div>
      <DocPageHeader title="Alerts" description="Provide contextual feedback messages for typical user actions with the handful of available and flexible alert messages." link={{
      ...
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Additional content" description="Alerts can contain whatever content you like. Headers, paragraphs, dividers, go crazy."/>
