...
const BadgeExample = () => {
    return (<div>
      <DocPageHeader title="Avatars" description="Use avater of different shapes and sizes with a single component."/>
      ...
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Contextual variations" description="Add any of the below mentioned modifier classes to change the appearance of a badge."/>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Examples" description="Badges scale to match the size of the immediate parent element by using relative font sizing and em units."/>
