...
const ButtonExample = () => {
    return (<div>
      <DocPageHeader title="Buttons" description={`Use Bootstrap’s custom button styles for actions in forms, dialogs, and more with support for multiple sizes, states, and more.`} link={{
      ...
      <DocPagesLayout sideNavItems={sideNavItems}>
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body code={buttonWithIconCode} scope={{ FontAwesomeIcon, FeatherIcon, Button, faPlus, faTrash }}/>
        </PhoenixDocCard>
        ...
        <DocPageHeader title="Button Group" id="button_group" description="Group a series of buttons together on a single line or stack them in a vertical column." link={{
            text: 'Buttons on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/button-group/`
        }}/>
