...
const ChecksExample = () => {
    return (<div>
      <DocPageHeader title="Checks and radios" description="Indicate the current page’s location within a navigational hierarchy that automatically adds separators via CSS." link={{
            text: 'Checks and radios on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/forms/checks-radios/`
        }}/>
