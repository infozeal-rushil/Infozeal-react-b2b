...
const DropdownExample = () => {
    return (<div className="mb-9">
      <DocPageHeader title="Dropdowns" description="Toggle contextual overlays for displaying lists of links and more with the Bootstrap dropdown plugin" link={{
            text: 'Dropdowns on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/dropdowns/`
        }}/>
