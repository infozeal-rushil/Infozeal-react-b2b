...
import { featherIconList } from '@globals/g-data/icons/featherIconList';
...
const FeatherIconsExample = () => {
    return (<div className="mb-9">
      <DocPageHeader title="Feather Icons" description="Simply beautiful open source icons" link={{
      ...
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body code={exampleCode} scope={{ FeatherIcon, Youtube, Facebook, Twitter }}/>
        </PhoenixDocCard>
        ...
        <PhoenixDocCard>
          ...
          <Card.Body>
            <Row className="mt-3">
              {featherIconList.map(icon => (<Col xs={12} sm={6} md={4} lg={3} key={icon}>
