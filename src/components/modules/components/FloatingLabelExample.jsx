...
const FloatingLabelExample = () => {
    return (<div>
      <DocPageHeader title="Floating labels" description="Create beautifully simple form labels that float over your input fields." link={{
            text: 'Floating labels on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/forms/floating-labels/`
        }}/>
      ...
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Layout" description="When working with the Bootstrap grid system, be sure to place form elements within column classes."/>
          <PhoenixDocCard.Body code={layoutCode}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Customizing rendering" description="When working with the Bootstrap grid system, be sure to place form elements within column classes.">
            <p className="mb-0">
