...
const FormValidationExample = () => {
    return (<div>
      <DocPageHeader title="Validation" description="Provide valuable, actionable feedback to your users with HTML5 form validation, via browser default behaviors or custom styles and JavaScript." link={{
