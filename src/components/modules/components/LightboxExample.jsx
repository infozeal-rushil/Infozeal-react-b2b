...
import img11 from '@src/assets/img/gallery/11.png';
import img12 from '@src/assets/img/gallery/12.png';
import img13 from '@src/assets/img/gallery/13.png';
import img9 from '@src/assets/img/gallery/9.png';
import img10 from '@src/assets/img/gallery/10.png';
import img24 from '@src/assets/img/gallery/24.png';
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body>
            <div>
              ...
              <div className="mb-3">
                <PhoenixLiveEditor
                  code={`import useLightbox from '@globals/g-hooks/useLightbox';`}
                />
              </div>
              <p className="mb-2">
