...
const ListGroupExample = () => {
    return (<div>
      <DocPageHeader title="List group" description="List groups are a flexible and powerful component for displaying a series of content. Modify and extend them to support just about any content within." link={{
            text: 'List groups on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/list-group/`
        }}/>
