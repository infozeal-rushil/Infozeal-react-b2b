...
const ModalExample = () => {
    return (<div>
      <DocPageHeader title="Modals" description="Add dialogs to your site for lightboxes, user notifications, or completely custom content." link={{
      ...
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Static backdrop" description="When backdrop is set to static, the modal will not close when clicking outside it. Click the button below to try it."/>
