...
const OffcanvasExample = () => {
    return (<div>
      <DocPageHeader title="Offcanvas" description="Build hidden sidebars into your project for navigation, shopping carts, and more." link={{
            text: 'Offcanvas on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/offcanvas/`
        }}/>
