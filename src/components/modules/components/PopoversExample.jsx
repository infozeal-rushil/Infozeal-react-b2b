...
const PopoversExample = () => {
    return (<div>
      <DocPageHeader title="Popovers" description="A popover component, like those found in iOS." link={{
            text: 'Popovers on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/overlays/#popovers`
        }}/>
