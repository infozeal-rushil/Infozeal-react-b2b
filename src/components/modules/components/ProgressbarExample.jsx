...
const ProgressbarExample = () => {
    return (<div>
      <DocPageHeader title="Progress" description="Provide up-to-date feedback on the progress of a workflow or action with simple yet flexible progress bars." link={{
            text: 'Progress on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/progress/`
        }}/>
      ...
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Contextual alternatives" description="Progress bars use some of the same button and alert classes for consistent styles."/>
          <PhoenixDocCard.Body code={bgCode}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Striped" description="Uses a gradient to create a striped effect."/>
