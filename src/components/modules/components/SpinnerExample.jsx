...
const SpinnerExample = () => {
    return (<div>
      <DocPageHeader title="Spinners" description="Spinners can be used to show the loading state in your projects." link={{
            text: 'Spinners on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/spinners/`
        }}/>
