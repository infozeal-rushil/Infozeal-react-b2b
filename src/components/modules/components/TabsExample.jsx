...
const TabsExample = () => {
    return (<div>
      <DocPageHeader title="Tabs" description="Create dynamic tabbed interfaces.Tabs is a higher-level component for quickly creating a Nav matched with a set of TabPanes." link={{
            text: 'Tabs on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/tabs/`
        }}/>
      <DocPagesLayout>
