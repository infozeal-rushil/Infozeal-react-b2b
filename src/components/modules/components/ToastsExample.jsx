...
const ToastsExample = () => {
    return (<div>
      <DocPageHeader title="Toasts" description="Push notifications to your visitors with a toast, a lightweight and easily customizable alert message." link={{
      ...
      <DocPagesLayout>
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body code={exampleCode} scope={{ UilTimes, Button }}/>
        </PhoenixDocCard>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Translucent" description="Toasts are slightly translucent, too, so they blend over whatever they might appear over."/>
          <PhoenixDocCard.Body code={transcluentCode} scope={{ UilTimes, Button }}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Stacking" description="When you have multiple toasts, we default to vertically stacking them in a readable manner."/>
          <PhoenixDocCard.Body code={stackingCode} scope={{ UilTimes, Button }}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Dismissible"/>
          <PhoenixDocCard.Body code={dismissibleCode} scope={{ UilTimes, Button }}/>
        </PhoenixDocCard>
        ...
        <PhoenixDocCard className="mb-4">
          ...
          <PhoenixDocCard.Body code={autoHideCode} scope={{ UilTimes, Button }}/>
        </PhoenixDocCard>
      </DocPagesLayout>
    </div>);
};
