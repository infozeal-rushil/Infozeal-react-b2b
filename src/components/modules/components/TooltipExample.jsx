...
const TooltipExample = () => {
    return (<div>
      <DocPageHeader title="Tooltips" description="A tooltip component for a more stylish alternative to that anchor tag title attribute." link={{
            text: 'Tooltips on react-bootstrap',
            url: `${import.meta.env.VITE_RB_URL_PREFIX || ''}/components/overlays/#tooltips`
        }}/>
