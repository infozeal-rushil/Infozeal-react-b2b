...
import PhoenixReactRange from '@globals/g-components/forms/PhoenixReactRange';
...
const ReactRangeExample = () => {
    return (<div className="mb-9">
      <DocPageHeader title="Range Slider" description={`${import.meta.env.VITE_TITLE} using React-range for advanced input with a slider which allows bring your own styles and markup.`} link={{
      ...
      <DocPagesLayout>
        <PhoenixDocCard className="overflow-visible mb-4">
          ...
          <PhoenixDocCard.Body code={defaultRangeCode} scope={{ PhoenixReactRange }}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="overflow-visible mb-4">
          <PhoenixDocCard.Header title="Range Connect"/>
          <PhoenixDocCard.Body code={RangeConnectCode} scope={{ PhoenixReactRange }}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="overflow-visible mb-4">
          <PhoenixDocCard.Header title="Colored Sliders"/>
          <PhoenixDocCard.Body code={ColoredSliderCode} scope={{ PhoenixReactRange }}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="overflow-visible mb-4">
          <PhoenixDocCard.Header title="Styling"/>
          <PhoenixDocCard.Body code={StylingCode} scope={{ PhoenixReactRange }}/>
        </PhoenixDocCard>
      </DocPagesLayout>
    </div>);
};
