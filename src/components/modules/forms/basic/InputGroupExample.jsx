...
const InputGroupExample = () => {
    return (<div>
      <DocPageHeader title="InputGroup" description="Easily extend form controls by adding text, buttons, or button groups on either side of textual inputs, custom selects, and custom file inputs." link={{
      ...
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Multiple inputs" description="While multiple inputs are supported visually, validation styles are only available for input groups with a single input."/>
          <PhoenixDocCard.Body code={multipleInputCode}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Multiple addons" description="Multiple add-ons are supported and can be mixed with checkbox and radio input versions."/>
