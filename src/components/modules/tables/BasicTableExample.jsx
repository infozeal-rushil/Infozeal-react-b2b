...
const BasicTableExample = () => {
    return (<div>
      <DocPageHeader title="Tables" description="Documentation and examples for opt-in styling of tables with React Bootstrap." link={{
      ...
      <DocPagesLayout>
        ...
        <DocPageHeader title="Responsive Tables" description="Responsive tables allow tables to be scrolled horizontally with ease." className="mb-5"/>
