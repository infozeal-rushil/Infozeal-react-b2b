...
const BorderExample = () => {
    return (<div>
      <DocPageHeader title="Borders" description="Use border utilities to quickly style the border and border-radius of an element. Great for images, buttons, or any other element."/>
      ...
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Border Color" description="Change the border color using utilities built on our theme colors."/>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Border Radius" description="Add classes to an element to easily round its corners."/>
          <PhoenixDocCard.Body code={borderRadiusCode}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Border Sizes" description="Use the scaling classes for larger or smaller rounded corners. Sizes range from 0 to 3, and can be configured by modifying the utilities API."/>
