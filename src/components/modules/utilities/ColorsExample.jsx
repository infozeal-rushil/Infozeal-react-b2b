...
const ColorsExample = () => {
    return (<div>
      <DocPageHeader title="Color" description="Convey meaning through color with a handful of color utility classes. Includes support for styling links with hover states, too."/>
