...
const GridExample = () => {
    return (<div>
      <DocPageHeader title="Grid system" description="Bootstrap’s grid system uses a series of containers, rows, and columns to layout and align content. It’s built with flexbox and is fully responsive. Below is an example and an in-depth look at how the grid comes together."/>
      <DocPagesLayout>
        ...
        <PhoenixDocCard noProvider className="mb-4">
          ...
          <PhoenixDocProvider>
            <PhoenixDocCard.Header className="border-bottom-0" description="You can also mix and match breakpoints to create different grids depending on the screen size."/>
