...
const InteractionsExample = () => {
    return (<div>
      <DocPageHeader title="Interactions" description="Utility classes that change how users interact with contents of a website."/>

      <DocPagesLayout>
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Text selection" description="Change the way in which the content is selected when the user interacts with it."/>
