...
const PositionExample = () => {
    return (<div>
      <DocPageHeader title="Position" description="Use these shorthand utilities for quickly configuring the position of an element."/>
      <DocPagesLayout>
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Position values" description="Quick positioning classes are available, though they are not responsive." noPreview/>
