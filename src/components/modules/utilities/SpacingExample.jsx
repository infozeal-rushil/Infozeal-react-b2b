...
const SpacingExample = () => {
    return (<div>
      <DocPageHeader title="Spacing" description="Bootstrap includes a wide range of shorthand responsive margin, padding, and gap utility classes to modify an element’s appearance."/>
      <DocPagesLayout>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Examples" noPreview description="Here are some representative examples of these classes:"/>
