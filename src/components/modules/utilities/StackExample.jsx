...
const StackExample = () => {
    return (<div>
      <DocPageHeader title="Stacks" description="Shorthand helpers that build on top of our flexbox utilities to make component layout faster and easier than ever." link={{
