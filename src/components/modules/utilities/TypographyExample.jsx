...
import PhoenixDocProvider from '@globals/g-providers/PhoenixDocProvider';
...
const fontWeightCode = `<>
  ...
  <div className="fw-semibold">Hello World 600</div>
...
const TypographyExample = () => {
    return (<div>
      <DocPageHeader title="Typography" description="Documentation and examples for common text utilities to control alignment, wrapping, weight, and more."/>
      <DocPagesLayout>
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Text alignment" description="Easily realign text to components with text alignment classes. For start, end, and center alignment, responsive classes are available that use the same viewport width breakpoints as the grid system."/>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Font family" description="You have three font-family helper classes available to use."/>
        ...
        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Text transform" description="Transform text in components with text capitalization classes."/>
          <PhoenixDocCard.Body code={textTransformCode}/>
        </PhoenixDocCard>

        <PhoenixDocCard className="mb-4">
          <PhoenixDocCard.Header title="Text decoration" description="Decorate text in components with text decoration classes."/>
