...
import img from '@src/assets/img/spot-illustrations/timeline.png';
import imgDark from '@src/assets/img/spot-illustrations/timeline-dark.png';
import { timelineData } from '@globals/g-data/timelineData';
import BasicTimeline from '@globals/g-components/timelines/BasicTimeline';
export const timelineBreadcrumb = [
  {
    label: 'Pages',
    url: '#!'
  },
