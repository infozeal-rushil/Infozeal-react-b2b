...
import PricingPackageList from '@globals/g-components/list-items/PricingPackageList';
import PricingGridItem from '@globals/g-components/pricing-items/PricingGridItem';
import { pricingBreadcrumbItems, pricingGridFeatures, pricingGridItems } from '@globals/g-data/pricing';
        ...
        <Col xl={12} xxl={9} className="mb-1">
          <Tab.Container defaultActiveKey="monthly">
            ...
            <Tab.Content>
              <Tab.Pane eventKey="yearly">
                <Row className="g-3">
                  {pricingGridItems.map(item => (<Col key={item.id} md={6} lg={12} xl={6}>
          ...
          <div>
            ...
            <div className="d-grid d-sm-flex">
              <Button variant="primary" size="lg" className="mb-3 mb-sm-0 me-sm-3 px-sm-8" endIcon={<FontAwesomeIcon icon={faAngleRight} transform="down-2"/>}>
                Subscribe Now
              </Button>
