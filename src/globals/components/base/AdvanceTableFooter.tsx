...
import { useAdvanceTableContext } from 'globals/providers/AdvanceTableProvider';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import classNames from 'classnames';
import usePagination from 'globals/hooks/usePagination';
import {
  faAngleRight,
  faChevronLeft,
  faChevronRight
      ...
      {navBtn && (
        <Col xs="auto" className="d-flex gap-2">
          <Button
            ...
            onClick={() => {
              previousPage();
              onPageChange?.(pageIndex); // because pageIndex is 0-based
            }}
          >
            Previous
          </Button>
          <Button
            ...
            onClick={() => {
              nextPage();
              onPageChange?.(pageIndex + 2); // Next page (convert 0-based to 1-based)
            }}
          >
            Next
          </Button>
