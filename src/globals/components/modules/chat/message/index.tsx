...
import Lightbox from 'globals/components/base/LightBox';
import { Message as MessageType, User, actions } from 'globals/data/chat';
import useLightbox from 'globals/hooks/useLightbox';
