...
import Badge from 'globals/components/base/Badge';
import PhoenixDocCard from 'globals/components/base/PhoenixDocCard';
import RevealDropdown, {
  RevealDropdownTrigger
} from 'globals/components/base/RevealDropdown';
import ActionDropdownItems from 'globals/components/common/ActionDropdownItems';
import FilterTab, { FilterTabItem } from 'globals/components/common/FilterTab';
import SearchBox from 'globals/components/common/SearchBox';
import DocPageHeader from 'globals/components/docs/DocPageHeader';
import PhoenixLiveEditor from 'globals/components/docs/PhoenixLiveEditor';
import { Project, projects, tableDocData } from 'globals/data/doc/table';
...
export const pannelMasterColumns = (
  ...
  handleDelete: (user: PannelUser) => void
): ColumnDef<PannelUser>[] => [
  // {
...
export const permissionTableColumns = (
  togglePermission: (rowIndex: number, key: PermissionKey) => void
): ColumnDef<PermissionObject>[] => [
  {
