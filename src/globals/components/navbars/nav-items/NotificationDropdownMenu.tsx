...
import Scrollbar from 'globals/components/base/Scrollbar';
import Button from 'globals/components/base/Button';
import { notifications as notificationData } from 'globals/data/notifications';
import NotificationItem from 'globals/components/common/NotificationItem';
