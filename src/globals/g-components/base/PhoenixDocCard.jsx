...
import { snakeCase } from '@globals/g-helpers/utils';
import { Link } from 'react-router-dom';
import PhoenixDocProvider, {
  usePhoenixDocContext
} from '@globals/g-providers/PhoenixDocProvider';
import PhoenixLiveProvider from '@globals/g-components/docs/PhoenixLiveProvider';
import { faCopy } from '@fortawesome/free-solid-svg-icons';
const PhoenixDocCard = ({ children, className, noProvider }) => {
  return (
    <Card
