import { UilBuilding, UilCheckCircle, UilClock, UilDollarAlt, UilEnvelopeAlt, UilFileCheckAlt, UilGlobe, UilPhone, UilPostcard } from '@iconscout/react-unicons';
...
const AboutLeadCard = ({ className }) => {
    return (<Card className={classNames(className)}>
      <Card.Body>
        ...
        <LeadInfoItem className="mb-4" label="Number of employees" icon={UilPostcard}>
          <p className="mb-0 text-body-secondary">126</p>
        </LeadInfoItem>

        <LeadInfoItem className="mb-4" label="Annual Revenue" icon={UilDollarAlt}>
        ...
        <LeadInfoItem className="mb-4" label="Lead source" icon={UilFileCheckAlt}>
