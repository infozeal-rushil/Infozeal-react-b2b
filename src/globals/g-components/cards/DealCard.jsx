import { faAngleDown, faSquareEnvelope, faSquarePhone } from '@fortawesome/free-solid-svg-icons';
...
const DealCard = ({ deal, columnId, cursor }) => {
      ...
      <Card className="mb-3">
        <Card.Body>
          <div className="d-flex align-items-center justify-content-between mb-3">
            ...
            <button className="btn p-0 deal-collapse-btn" onClick={handleOpenDetails}>
              <FontAwesomeIcon icon={faAngleDown} className={classNames('text-body-tertiary fs-8', {
            show: deal.openDetails
        })}/>
            </button>
          </div>
          <div className="d-flex align-items-center mb-2">
            <Link to="/apps/crm/deal-details" className="fw-bold line-clamp-1 me-3 fs-7">
              {deal.title}
            </Link>
            <p className={classNames('fs-10 mb-0', {
            'd-none': !deal.openDetails
        })}>
              <FeatherIcon icon="grid" size={12} className="text-body-quaternary me-1"/>
              {deal.category}
            </p>
            <p className={classNames('ms-auto fs-9 text-body-emphasis fw-semibold mb-0', {
            'd-none': deal.openDetails
        })}>
          ...
          <div className={classNames('d-flex flex-between-center mb-2', {
            'd-none': deal.openDetails
        })}>
          ...
          <Collapse in={deal.openDetails}>
                  ...
                  <tbody>
                    <tr>
                      <td className="d-flex gap-2 align-items-center">
                        <FeatherIcon icon="dollar-sign" size={16} className="text-body-tertiary"/>
            ...
            minimumFractionDigits: 2
                    ...
                    <tr>
                      <td className="d-flex gap-2 align-items-center">
                        <FeatherIcon icon="user" size={16} className="text-body-tertiary"/>
                        <p className="fw-semibold fs-9 mb-0 text-body-tertiary">
                          Company Name
                        </p>
                      </td>
                      ...
                      <td className="fw-semibold fs-9 mb-0 text-body-emphasis">
                        <p className="align-items-center d-flex fs-9 fw-semibold gap-2 mb-0 text-body-emphasis">
                          {deal.company}
                          <Link to="#!">
                            <FontAwesomeIcon icon={faSquarePhone} className="text-body-tertiary"/>
                          </Link>
                          <Link to="#!">
                            <FontAwesomeIcon icon={faSquareEnvelope} className="text-body-tertiary"/>
                          </Link>
                          <Link to="#!">
                            <FontAwesomeIcon icon={faWhatsappSquare} className="text-body-tertiary"/>
                          </Link>
                        </p>
                      </td>
                    </tr>
                    <tr>
                      <td className="d-flex gap-2 align-items-center">
                        <FeatherIcon icon="calendar" size={16} className="text-body-tertiary"/>
                        <p className="fw-semibold fs-9 mb-0 text-body-tertiary">
                          Closing Date & Time
                        </p>
                      </td>
                    ...
                    <tr>
                      <td className="d-flex gap-2 align-items-center">
                        <FeatherIcon icon="headphones" size={16} className="text-body-tertiary"/>
                        <p className="fw-semibold fs-9 mb-0 text-body-tertiary">
                          Assigned Agent
                        </p>
                      </td>
                      <td>:</td>
                      <td className="fw-semibold fs-9 mb-0 text-body-emphasis">
                        <Form.Select size="sm" className="py-0 ms-n3 border-0 shadow-none">
                          {[
            'Ally Aagaard',
            'Lonnie Kub',
            'Aida Moen',
            ...
            'Brain Cole',
            'Reese Mann'
        ].map(agent => (<option key={agent}>{agent}</option>))}
                        </Form.Select>
                      </td>
                    </tr>
                  </tbody>
              ...
              <ProgressBar style={{ height: '8px' }} now={Number(deal.probability.value)} variant={deal.probability.variant}/>
            </div>
          </Collapse>
        </Card.Body>
      </Card>
