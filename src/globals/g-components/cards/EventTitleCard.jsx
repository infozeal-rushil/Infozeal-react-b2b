...
const EventTitleCard = ({ className }) => {
      ...
      <Card.Body>
                  ...
                  <div className="mb-3">
                    <div className="d-flex align-items-center">
                      <div className="px-2 py-1 bg-info-subtle rounded">
                        <FeatherIcon icon="map-pin" className="text-info" size={16}/>
                      </div>
                ...
                <div className="mb-3">
                  <div className="d-flex align-items-center">
                    <div className="px-2 py-1 bg-primary-subtle rounded">
                      <FeatherIcon icon="clock" className="text-primary" size={16}/>
                    </div>
        ...
        <Row className="g-2">
          ...
          <Col xs={12} sm="auto" className="flex-sm-grow-1 flex-md-grow-0">
            <Button variant="phoenix-primary" className="w-100" startIcon={<FontAwesomeIcon icon={faCalendarPlus} className="me-2"/>}>
              Add to Calendar
            </Button>
          </Col>
          <Col xs={6} sm="auto">
            <Button variant="phoenix-primary" className="w-100" startIcon={<FontAwesomeIcon icon={faHeart} className="me-2"/>}>
              3677
            </Button>
          </Col>
          <Col xs={6} sm="auto">
            <Button variant="phoenix-primary" className="w-100" startIcon={<FontAwesomeIcon icon={faShareNodes} className="me-2"/>}>
              4467
            </Button>
          </Col>
        </Row>
