...
export const HolidaysCard = () => {
    return (<Card className="h-100">
      <Card.Header className="border-0 pb-2 d-md-flex flex-wrap justify-content-between align-items-start">
        ...
        <Button variant="phoenix-secondary" size="sm" as={Link} to={`#!`} endIcon={<FontAwesomeIcon icon={faChevronRight} className="ms-2 fs-10"/>}>
          Go to Calender
        </Button>
      </Card.Header>
      <Card.Body>
        <HolidaysNextMonth style={{ height: '100%', minHeight: '300px', width: '100%' }}/>
      </Card.Body>
    </Card>);
};
