...
const HotelCard = ({ hotelInfo }) => {
    ...
    return (<div className="hover-actions-trigger mx-auto rounded-3 overflow-hidden">
      ...
      <div className="backdrop-faded backdrop-secondary-dark h-100 d-flex flex-column justify-content-end">
        <Link className="stretched-link fs-7 text-white fw-bold" to="/apps/travel-agency/hotel/customer/hotel-details">
          {name}
        </Link>
        ...
        <div className="d-flex align-items-center gap-3">
          <Badge variant="phoenix" bg="warning" className="fs-8 fw-normal">
            <FontAwesomeIcon icon={faStar} className="text-warning-emphasis me-1 fs-9" transform="up-1"/>
            {rating}
          </Badge>
