    ...
    return (<Card>
      <Card.Body>
        <div className="border-bottom border-translucent">
          <div className="d-flex align-items-start mb-1">
            ...
            <div className="d-sm-flex align-items-center ps-3">
              <Link to="/apps/crm/report-details" className="fw-bold fs-7 lh-sm line-clamp-1 me-sm-4">
                {report.title}
              </Link>
              <div className="d-flex align-items-center">
                <FontAwesomeIcon icon={faCircle} transform="shrink-6 up-1" className={`me-1 text-${report.priority.type}`}/>
        ...
        <Row className="g-1 g-sm-3 mt-2 lh-1">
          ...
          <Col sm="auto">
            <div className="d-flex align-items-center">
              <FeatherIcon icon="grid" width={16} height={16} className="me-2"/>
          ...
          <Col sm="auto">
            <div className="d-flex align-items-center">
              <FeatherIcon icon="clock" className="me-2" width={16} height={16}/>
              <p className="mb-0 fs-9 fw-semibold text-body-tertiary">
                {report.date}
              </p>
            </div>
