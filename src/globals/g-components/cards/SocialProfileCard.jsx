...
import coverImage from '@src/assets/img/generic/59.png';
...
const SocialProfileCard = ({ showAbout, avatar, className }) => {
  return (
    <Card className={className}>
      ...
      >
        <CoverUpload
          src={coverImage}
          gradient={'linear-gradient(0deg, #000000 -3%, rgba(0, 0, 0, 0) 83%)'}
        />
        <AvatarUpload
          size="4xl"
          src={avatar}
