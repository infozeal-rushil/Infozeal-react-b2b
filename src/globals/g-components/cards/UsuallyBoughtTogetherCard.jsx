...
const ProductListItem = ({ product }) => {
    ...
    return (<div className="d-flex align-items-center">
      <Form.Check checked={checked} className="me-2" onChange={e => {
            setChecked(e.target.checked);
        }}/>
      <img className="border border-translucent rounded" src={product.img} width="53" alt=""/>
      <div className="ms-2">
...
const UsuallyBoughtTogetherCard = ({ className, products }) => {
