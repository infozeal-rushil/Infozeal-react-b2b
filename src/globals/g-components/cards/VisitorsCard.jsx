...
export const VisitorsCard = () => {
    ...
    return (<Card className="h-100">
      <Card.Header className="border-0 d-flex justify-content-between align-items-start">
        ...
        <Dropdown>
          <Dropdown.Toggle size="sm" variant="phoenix-secondary" className="dropdown-caret-none px-3 bg-body-emphasis bg-body-hover">
      ...
      <Card.Body className="py-0">
        ...
        <CountryWiseVitorsChart updateUserCounder={updateUserCounder} style={{ height: '43px', width: '100%' }}/>
        <VisitorsTable />
      </Card.Body>
    </Card>);
};
