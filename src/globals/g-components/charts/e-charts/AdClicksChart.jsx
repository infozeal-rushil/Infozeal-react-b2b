...
const getDefaultOptions = (getThemeColor, theme) => ({
    tooltip: {
        trigger: 'axis',
        padding: 10,
...
const AdClicksChart = ({ style }) => {
    const { config: { theme }, getThemeColor } = useAppContext();
    return (<ReactEChartsCore echarts={echarts} option={getDefaultOptions(getThemeColor, theme)} style={style}/>);
};
