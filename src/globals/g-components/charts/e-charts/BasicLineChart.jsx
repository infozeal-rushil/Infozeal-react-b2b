...
const getDefaultOptions = (getThemeColor, data, dates) => ({
    tooltip: {
        trigger: 'axis',
        padding: 10,
...
const BasicLineChart = ({ style, dates, data }) => {
    const { getThemeColor } = useAppContext();
    return (<ReactEChartsCore echarts={echarts} option={getDefaultOptions(getThemeColor, data, dates)} style={style}/>);
};
