...
const getDefaultOptions = (theme, getThemeColor) => ({
...
const CompletedTaskChart = () => {
    ...
    return (<ReactEChartsCore echarts={echarts} option={getDefaultOptions(theme, getThemeColor)} style={{ height: 200, width: '100%' }}/>);
};
