...
const getDefaultOptions = (getThemeColor) => ({
    ...
    xAxis: {
        ...
        axisLabel: {
            ...
            formatter: (value) => dayjs(value).format('D MMM, YY'),
...
const ContactsCreatedChart = ({ style }) => {
    const { getThemeColor } = useAppContext();
    return (<ReactEChartsCore echarts={echarts} option={getDefaultOptions(getThemeColor)} style={style}/>);
};
