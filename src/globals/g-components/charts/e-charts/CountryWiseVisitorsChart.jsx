...
const CountryWiseVitorsChart = ({ style, updateUserCounder }) => {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            ...
            (_b = (_a = chartRef === null || chartRef === void 0 ? void 0 : chartRef.current) === null || _a === void 0 ? void 0 : _a.getEchartsInstance()) === null || _b === void 0 ? void 0 : _b.setOption({
                xAxis: {
                    data: axisData
                },
                series: [
    ...
    return (<ReactEChartsCore echarts={echarts} ref={chartRef} option={getDefaultOptions(getThemeColor, isDark)} style={style}/>);
};
