...
const MarketingCampaignChart = ({ style }) => {
    const chartRef = useRef(null);
    const updateDimensions = () => {
        var _a, _b, _c;
        if (window.innerWidth < 1200) {
            (_b = (_a = chartRef.current) === null || _a === void 0 ? void 0 : _a.getEchartsInstance()) === null || _b === void 0 ? void 0 : _b.setOption({
                radar: {
                    radius: '74%'
                }
            });
    ...
    return (<ReactEChartsCore ref={chartRef} echarts={echarts} option={getDefaultOptions(getThemeColor, isDark)} style={style}/>);
};
