...
const StoreItem = ({ store }) => {
    return (<RevealDropdownTrigger className="hover-actions-trigger">
      <div className="border border-translucent d-flex flex-center rounded-3 mb-3 p-4" style={{ height: 180 }}>
      ...
      <RevealDropdown className="hover-actions top-0 end-0 mt-2 me-2" btnClassName="btn-icon">
        <ActionDropdownItems />
      </RevealDropdown>
