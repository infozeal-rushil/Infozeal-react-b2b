...
const LinkItem = ({ children, to }) => {
    return (<Link to={to} className="text-body-tertiary fw-semibold fs-9 mb-1">
      {children}
    </Link>);
};
const EcommerceFooter = () => {
    return (<section className="bg-body-highlight dark__bg-gray-1100 py-9">
          ...
          <Col xs={6} md="auto">
            ...
            <Stack>
              ...
              <Link to="#!" className="mb-1 fw-semibold fs-9">
                <FontAwesomeIcon icon={faFacebookSquare} className="text-primary me-2 fs-8"/>
                <span className="text-body-secondary">Facebook</span>
              </Link>
              <Link to="#!" className="mb-1 fw-semibold fs-9">
                <FontAwesomeIcon icon={faTwitterSquare} className="text-info me-2 fs-8"/>
