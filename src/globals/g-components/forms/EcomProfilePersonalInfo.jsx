        ...
        <Col xs={12} lg={6}>
          <Row className="g-2 gy-lg-0">
            ...
            <Col xs={6} sm={2} lg={3} xl={2}>
              <Form.Select>
                {Array.from(Array(30).keys()).map(date => (<option value={date} key={date}>
                    {date + 1}
                  </option>))}
              </Form.Select>
            </Col>
            <Col xs={6} sm={2} lg={3} xl={2}>
              <Form.Select>
                {dayjs.months().map(month => (<option value={month} key={month}>
                    {month.slice(0, 3)}
                  </option>))}
              </Form.Select>
            </Col>
            <Col xs={12} sm={8} lg={6} xl={8}>
              <Form.Select>
                {getNumbersInRange(1990, 2023).map(year => (<option value={year} key={year}>
                    {year}
                  </option>))}
              </Form.Select>
            </Col>
