...
const EventTicketPricing = () => {
    return (<>
      ...
      <Row className="g-3 mb-7 mt-1 border-bottom border-translucent pb-5">
        ...
        <Col xs={6} xl={5}>
          <Form.Control type="number" placeholder="$0.0" className="input-spin-none"/>
        </Col>
        <Col xs={6} xl={7}>
        ...
        <Col xs={12}>
          <Button className="p-0" startIcon={<FontAwesomeIcon icon={faPlus} className="me-2"/>} variant="link">
            Add an option
          </Button>
        </Col>
      </Row>
