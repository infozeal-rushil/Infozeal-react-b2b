...
const LeadInformationForm = ({ className }) => {
    return (<>
      ...
      <Row className={classNames('g-3', className)}>
        ...
        <Col sm={6} md={4}>
          <FloatingLabel controlId="alternative-email" label="Alternative email">
            <Form.Control type="email" placeholder="Alternative email"/>
          </FloatingLabel>
        </Col>
        <Col sm={6} md={4}>
          <FloatingLabel controlId="phone" label="Phone">
            <Form.Control type="number" placeholder="Phone" className="input-spin-none"/>
          </FloatingLabel>
        </Col>
        <Col sm={6} md={4}>
        ...
        <Col sm={6} md={4}>
          <FloatingLabel controlId="number-of-employees" label="Number of employees">
