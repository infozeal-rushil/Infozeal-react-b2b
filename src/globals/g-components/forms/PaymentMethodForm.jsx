...
import visaCardImage from '@src/assets/img/logos/visa.png';
import discoverImage from '@src/assets/img/logos/discover.png';
import masterCardImage from '@src/assets/img/logos/mastercard.png';
import americanExpressImage from '@src/assets/img/logos/american_express.png';
import classNames from 'classnames';
const PaymentMethodForm = ({ className, marginTop = 'default' }) => {
