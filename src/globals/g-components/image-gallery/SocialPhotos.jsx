...
const SocialPhotos = ({ className, photos }) => {
    ...
    return (<div className={className}>
      ...
      <Row className="g-3">
        {photos.map((img, index) => (<Col key={img} xs={4}>
            <img src={img} alt="" className="w-100 rounded-3 cursor-pointer" onClick={() => openLightbox(index + 1)}/>
          </Col>))}
      </Row>
    </div>);
};
