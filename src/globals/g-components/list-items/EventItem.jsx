...
const EventItem = ({ event }) => {
    return (<div key={event.title} className="py-3 border-bottom border-translucent border-dashed">
      ...
      <Link to="#!" className="hover-primary text-body-highlight fw-bold mb-2 line-clamp-1 me-5 lh-base">
        {event.title}
      </Link>
      ...
      <p className="fs-9 text-body-tertiary fw-bold mb-0">
        <FontAwesomeIcon icon={faMapMarkerAlt} className="text-body-secondary me-1"/>
        {event.place}
      </p>
    </div>);
};
