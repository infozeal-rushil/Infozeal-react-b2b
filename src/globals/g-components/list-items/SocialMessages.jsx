...
const SocialMessages = ({ messages }) => {
    return (<>
      ...
      {messages.map(message => (<div key={message.id} className="d-flex py-3 align-items-center border-bottom border-translucent border-dashed">
          <div className="me-2">
            <Avatar size={message.avatar.size} src={message.avatar.img} status={message.avatar.status}/>
          </div>
