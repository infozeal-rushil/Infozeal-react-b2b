...
const FilterDealsModal = ({ show, handleClose }) => {
    return (<Modal show={show} onHide={handleClose} className="p-0" centered contentClassName="border">
      ...
      <Modal.Footer className="d-flex justify-content-end align-items-center px-4 pb-4 border-0 pt-3">
        <Button variant="phoenix-primary" size="sm" className="px-4 fs-10 my-0" startIcon={<FontAwesomeIcon icon={faArrowsRotate} className="me-2 fs-10"/>}>
          Reset
        </Button>
