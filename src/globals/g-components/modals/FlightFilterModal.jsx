...
import { faMagnifyingGlass, faRotate, faTimes } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { FilterFormFlightAirlines, FilterFormFlightCabin, FilterFormFlightDuration, FilterFormFlightPriceCalculator, FilterFormFlightStops } from 'components/modules/travel-agency/flight/homepage/FlightFilterFormContent';
...
const FlightFilterModal = ({ show, handleModalClose }) => {
    return (<Modal show={show} onHide={handleModalClose} className="p-0 border-0" centered fullscreen={'md-down'} dialogClassName="modal-53w" scrollable={true}>
        ...
        <Form>
          ...
          <div className="modal-footer border-0 px-0 pt-3 pb-4">
            <div className="w-100 d-flex flex-wrap gap-3 border-top border-translucent pt-4">
              ...
              <Button variant="primary" className="m-0 text-nowrap flex-1" type="submit" size="lg" startIcon={<FontAwesomeIcon icon={faMagnifyingGlass} className="me-2"/>}>
                Update results
              </Button>
            </div>
          </div>
