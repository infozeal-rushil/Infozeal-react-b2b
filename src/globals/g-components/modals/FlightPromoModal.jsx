...
import spotIllustration44 from '@src/assets/img/spot-illustrations/44.png';
import spotIllustrationDark44 from '@src/assets/img/spot-illustrations/44-dark.png';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faTimes } from '@fortawesome/free-solid-svg-icons';
import Button from 'components/base/Button';
const FlightPromoModal = ({ show, handleClose }) => {
  return (
    <Modal
      show={show}
