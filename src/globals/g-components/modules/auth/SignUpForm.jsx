    ...
    return (<>
      ...
      <Form>
        ...
        <Row className="g-3 mb-3">
          ...
          <Col sm={layout === 'card' ? 12 : 6} lg={6}>
            <Form.Group>
              ...
              <Form.Control id="confirmPassword" type="text" placeholder="Confirm Password"/>
            </Form.Group>
          </Col>
        </Row>
        <Form.Check type="checkbox" className="mb-3">
          <Form.Check.Input type="checkbox" name="termsService" id="termsService"/>
        ...
        <div className="text-center">
          <Link to={`/pages/authentication/${layout}/sign-in`} className="fs-9 fw-bold">
