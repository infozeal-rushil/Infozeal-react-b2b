...
import { faBan, faBellSlash, faChevronLeft, faEllipsisV, faFlag, faGear, faHandHoldingHeart, faPalette, faPhone, faSearch, faUserPen, faUserPlus, faVideo } from '@fortawesome/free-solid-svg-icons';
const ConversationDetails = ({ conversation, handleClose }) => {
    return (<>
      <div className="border-bottom border-translucent p-4">
        <div className="d-flex flex-between-center">
          <Button className="p-0" onClick={handleClose}>
            <FontAwesomeIcon icon={faChevronLeft} className="text-body-tertiary"/>
          </Button>
          <Dropdown align="end">
            <Dropdown.Toggle variant="" size="sm" className="p-0 btn-reveal dropdown-toggle dropdown-caret-none transition-none">
              <FontAwesomeIcon icon={faEllipsisV} className="text-body-tertiary"/>
            </Dropdown.Toggle>
