...
const LeadDetailsOffcanvas = ({ open, setOpen }) => {
    const { breakpoints } = useBreakpoints();
    return (<>
      {breakpoints.down('md') && (<PhoenixOffcanvas open={open} onHide={() => setOpen(false)} style={{ maxWidth: 350 }} className="p-4 pt-3 phoenix-offcanvas-content scrollbar" placement="start" fixed>
          <div>
