      ...
      <Row className="g-6">
        <Col md={6} className="mb-2 mb-sm-0">
          <div className="d-flex gap-2 align-items-center">
            ...
            <Badge bg="success" variant="phoenix" iconPosition="end" className="fs-10">
              +24.5%
              <FontAwesomeIcon icon={faCaretUp} className="d-inline-block lh-1 ms-1" transform="down-2"/>
            </Badge>
          </div>
          <div className="pb-0 pt-4">
            <BasicLineChart data={[
            220, 220, 150, 150, 150, 250, 250, 400, 400, 400, 300, 300
        ]} dates={getPastDates(12)} style={{ height: 110, width: '100%' }}/>
          </div>
        </Col>
        <Col md={6}>
          <div className="d-flex gap-2 align-items-center">
          ...
          <div className="pb-0 pt-4">
            <BasicLineChart data={[100, 100, 260, 250, 270, 160, 190, 180, 260, 200, 220]} dates={getPastDates(11)} style={{ height: 110, width: '100%' }}/>
          </div>
        </Col>
      </Row>
    </>);
