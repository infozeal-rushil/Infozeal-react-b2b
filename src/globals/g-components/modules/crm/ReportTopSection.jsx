...
const ReportTopSection = () => {
    ...
    return (<Row className="g-3 justify-content-between mb-4">
      <Col xs="auto">
      ...
      <Col xs="auto">
        <div className="d-flex">
          ...
          <Button variant="phoenix-secondary" className="px-3" onClick={() => setOpenFilterModal(true)}>
            <FontAwesomeIcon icon={faFilter} transform="down-3" className="text-primary"/>
          </Button>
        </div>
        <ReportFilterModal show={openFilterModal} handleClose={() => setOpenFilterModal(false)}/>
      </Col>
    </Row>);
};
