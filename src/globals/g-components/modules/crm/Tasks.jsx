...
const Tasks = () => {
    return (<div>
      ...
      {leadTasks.map((todo, index) => (<TodoListItem key={todo.task} todo={todo} className={classNames('border-translucent', {
                'border-top': index === 0,
                'border-bottom-0': index === leadTasks.length - 1
            })} fullLayoutBreakpoints={['md', 'xxl']} halfLayoutBreakpoints={['xl']}/>))}{' '}
