...
const MarketingCampaign = () => {
    return (<>
      ...
      <Row className="g-3 align-items-center">
        ...
        <Col sm={4} md={12} lg={4} xl={12} xxl={4} className="d-flex justify-content-end-xxl mt-0">
          <div className="d-flex flex-1 justify-content-center d-sm-block d-md-flex d-lg-block d-xl-flex d-xxl-block">
            <div className="mb-4 me-6 me-sm-0 me-md-6 me-lg-0 me-xl-6 me-xxl-0">
              ...
              <div className="d-flex align-items-center">
                <FontAwesomeIcon icon={faCircle} className="text-warning-light me-2"/>
            ...
            <div>
              ...
              <div className="d-flex align-items-center">
                <FontAwesomeIcon icon={faCircle} className="text-primary-light me-2"/>
