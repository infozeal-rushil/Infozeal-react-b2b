...
const AddDealModal = ({ show, handleClose }) => {
    return (<Modal size="xl" show={show} centered backdrop="static" onHide={handleClose} contentClassName="bg-body-highlight p-6 border border-translucent">
      ...
      <Modal.Body className="px-0 mb-6">
        <Row className="g-4">
          <Col lg={6} className="d-flex flex-column gap-4">
            ...
            <Row className="g-3">
              <Form.Group as={Col} lg={12} xl={6}>
                ...
                <Row className="g-2">
                  <Col xs={7}>
                    <Form.Control type="number" placeholder="$ Enter amount" className="flex-1"/>
                  </Col>
                  <Col xs={5}>
            ...
            <Form.Group>
              <div className="mb-2">
                ...
                <Button variant="link" className="p-0 ms-3" startIcon={<FontAwesomeIcon icon={faPlus} className=""/>}>
                  Add new
                </Button>
              </div>
          ...
          <Col lg={6} className="d-flex flex-column gap-4">
            ...
            noCalendar: true,
            dateFormat: 'H:i'
        }} placeholder="Select Time" hideIcon={true}/>
              </Form.Group>
            </Row>
      ...
      <Modal.Footer className="border-0 p-0">
        <Button variant="link" className="text-danger px-3 my-0" onClick={handleClose}>
          Cancel
        </Button>
