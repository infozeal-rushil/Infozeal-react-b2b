...
const ProductDescription = () => {
    ...
    return (<Row className="g-5 mb-5 mb-lg-8">
      <Col xs={12} lg={6}>
        {selectedVariant && <ProductGallery images={selectedVariant.images}/>}
        <div className="d-flex">
          <Button variant="outline-warning" size="lg" className="rounded-pill w-100 me-3 px-2 px-sm-4 fs--1 fs-sm-0">
            <FontAwesomeIcon icon={faHeart} className="me-2"/>
            Add to wishlist
          </Button>
          <Button variant="warning" size="lg" className="rounded-pill w-100 px-2 px-sm-4 fs--1 fs-sm-0">
            ...
            <div className="mb-3">
              <p className="fw-semibold mb-2 text-body">
                ...
                <span className="text-body-emphasis">
                  {selectedVariant === null || selectedVariant === void 0 ? void 0 : selectedVariant.name}
                </span>
              </p>
              <ProductColorNav selectedVariantKey={selectedVariantKey} setSelectedVariantKey={setSelectedVariantKey}/>
            </div>
