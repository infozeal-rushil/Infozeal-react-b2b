import { faAngleLeft, faAngleRight, faArchive, faRedo, faStar, faTag, faTrash } from '@fortawesome/free-solid-svg-icons';
...
const InboxToolbar = ({ size = 'lg', className }) => {
    const { getParentCheckboxProps } = useBulkSelect();
    return (<>
      <div className={classNames(className, 'd-flex align-items-center flex-wrap position-sticky pb-2 bg-body z-2 email-toolbar')}>
        ...
        <div className="d-flex gap-3">
          ...
          <Button className="p-0" type="button">
            <FontAwesomeIcon icon={faAngleLeft} className="text-body-quaternary fs-10"/>
          </Button>
          <Button className="p-0" type="button">
            <FontAwesomeIcon icon={faAngleRight} className="text-primary fs-10"/>
          </Button>
        </div>
      </div>
      <div className="border-y border-translucent py-2 d-flex justify-content-between">
        ...
        <div className="d-flex gap-2">
          <TooltipIconButton iconClass="fs-10" title="Archive" icon={faArchive}/>
