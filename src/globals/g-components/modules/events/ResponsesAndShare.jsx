import { faFacebook, faFacebookMessenger, faLinkedinIn, faTwitter } from '@fortawesome/free-brands-svg-icons';
...
const ResponsesAndShare = () => {
    return (<>
      ...
      <div className="d-flex mb-6">
        ...
        <div className="my-3 mx-2 mx-sm-3 border-start border-translucent"/>
        <div className="mx-3">
