...
const FaqCategoryCard = ({ category }) => {
    ...
    return (<Nav.Link eventKey={category.id} className={`btn bg-body-emphasis w-100 px-3 pt-4 pb-3 fs-8 ${subCategoryActiveKey === category.id && 'active'}`}>
      <FontAwesomeIcon icon={category.icon} className="category-icon text-body-secondary fs-6"/>
