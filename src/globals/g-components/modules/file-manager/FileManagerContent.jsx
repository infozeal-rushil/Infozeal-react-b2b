...
import illustration47 from '@src/assets/img/spot-illustrations/47.png';
import illustration47Dark from '@src/assets/img/spot-illustrations/47_dark.png';
import illustration48 from '@src/assets/img/spot-illustrations/48.png';
import illustration48Dark from '@src/assets/img/spot-illustrations/48_dark.png';
const FileManagerContent = () => {
  ...
  useEffect(() => {
    if (isGridView) {
      const state = fileCollection.reduce((acc, file, index) => {
