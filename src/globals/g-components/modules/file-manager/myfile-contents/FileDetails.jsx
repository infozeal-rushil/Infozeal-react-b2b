...
import lightImg from '@src/assets/img/spot-illustrations/46.png';
import darkImg from '@src/assets/img/spot-illustrations/dark_46.png';
              ...
              <Tab.Container id="file-details-tab" defaultActiveKey="first">
                ...
                <Tab.Content>
                  <Tab.Pane eventKey="first">
                    ...
                    <AvatarDropdown
                      user={Object.assign(Object.assign({}, data.admin), {
                        id: 100,
                        username: '',
                        connections: 23,
                        mutual: 4
                    ...
                    <Avatar.Group size="m">
                      {data.assignees.map((member, index) => (
                        <AvatarDropdown
                          key={index}
                          user={Object.assign(Object.assign({}, member), {
                            id: index,
                            username: '',
                            connections: 23,
                            mutual: 4
