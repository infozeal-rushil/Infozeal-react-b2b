...
const MyFilesHeader = () => {
    ...
    const { isGridView, setIsGridView, isGrouped, setIsGrouped } = useFileManagerContext();
    ...
    return (<Row className="g-3 flex-between-center">
      <Col xs="auto">
        <h5 className="mb-0">
      ...
      <Col xs="auto" className="d-flex">
        <OverlayTrigger show={showGridTooltip} onToggle={setShowGridTooltip} overlay={<Tooltip>Grid view</Tooltip>}>
          <Button onClick={() => {
            setIsGridView(true);
            setShowGridTooltip(!showGridTooltip);
        }} variant="phoenix-secondary" className={classNames('btn-square me-2', {
        ...
        <OverlayTrigger show={showListTooltip} onToggle={setShowListTooltip} overlay={<Tooltip>List view</Tooltip>}>
          <Button onClick={() => {
            setIsGridView(false);
            setShowListTooltip(!showListTooltip);
        }} variant="phoenix-secondary" className={classNames('btn-square', {
            'border-primary text-primary': !isGridView
        })}>
        ...
        <OverlayTrigger show={groupViewTooltip} onToggle={setGroupViewTooltip} overlay={<Tooltip>View as group</Tooltip>}>
          <Form.Check type="switch" id="viewAsGroup" className="mb-0 d-flex align-items-center" checked={isGrouped} onChange={() => {
