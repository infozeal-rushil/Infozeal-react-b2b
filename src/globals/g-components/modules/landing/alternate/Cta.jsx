...
import bg38 from '@src/assets/img/bg/bg-38.png';
import illustrations37 from '@src/assets/img/spot-illustrations/37.png';
import illustrations37dark from '@src/assets/img/spot-illustrations/37_2.png';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faCircle } from '@fortawesome/free-solid-svg-icons';
import bgLeft from '@src/assets/img/bg/bg-left-24.png';
import bgRight from '@src/assets/img/bg/bg-right-24.png';
const Cta = () => {
  return (
