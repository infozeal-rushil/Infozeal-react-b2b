import bgLeft from '@src/assets/img/bg/bg-left-26.png';
import bgRight from '@src/assets/img/bg/bg-right-26.png';
import IsotopeNav from 'components/navs/IsotopeNav';
import useLightbox from 'hooks/useLightbox';
import { useState } from 'react';
import img1 from '@src/assets/img/gallery/27.png';
import img2 from '@src/assets/img/gallery/28.png';
import img3 from '@src/assets/img/gallery/29.png';
import img4 from '@src/assets/img/gallery/30.png';
import img5 from '@src/assets/img/gallery/31.png';
import img6 from '@src/assets/img/gallery/32.png';
import img7 from '@src/assets/img/gallery/33.png';
import img8 from '@src/assets/img/gallery/34.png';
...
const Gallery = () => {
  ...
  const handleNavItemSelect = category => {
