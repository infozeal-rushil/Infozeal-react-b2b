...
import bg1 from '@src/assets/img/bg/bg-36.png';
import bg2 from '@src/assets/img/bg/bg-34.png';
import bg3 from '@src/assets/img/bg/bg-35.png';
import bg4 from '@src/assets/img/bg/bg-39.png';
const HeroHeader = () => {
  return (
