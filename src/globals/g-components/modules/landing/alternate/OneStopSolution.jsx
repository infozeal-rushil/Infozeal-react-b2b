...
import earthLight from '@src/assets/img/animated-icons/rotating-earth.json';
import earthDark from '@src/assets/img/animated-icons/rotating-earth-dark.json';
import earthPlane from '@src/assets/img/spot-illustrations/earth-plane.png';
import earthPlaneDark from '@src/assets/img/spot-illustrations/earth-plane-dark.png';
