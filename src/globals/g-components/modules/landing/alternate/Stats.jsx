import bgLeft from '@src/assets/img/bg/bg-left-25.png';
import bgRight from '@src/assets/img/bg/bg-right-25.png';
import classNames from 'classnames';
import { stats } from 'data/landing/alternate-landing-data';
