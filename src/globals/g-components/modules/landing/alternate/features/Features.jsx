...
const Features = () => {
    return (<section id="features" className="pt-13 pb-10">
      <div className="container-small px-lg-7 px-xxl-3">
        <div className="text-center mb-10 mb-md-5">
          ...
          <div className="text-center mt-5">
            <Button variant="outline-primary" endIcon={<FontAwesomeIcon icon={faAngleRight} transform="down-1"/>}>
              See more
            </Button>
          </div>
        </div>
        {features.map((feature, index) => (<FeatureSection key={feature.id} feature={feature} isLast={index === features.length - 1}/>))}
      </div>
    </section>);
};
