...
import bg18 from '@src/assets/img/bg/bg-18.png';
import illustrations27 from '@src/assets/img/spot-illustrations/27.png';
import illustrations27dark from '@src/assets/img/spot-illustrations/dark_27.png';
