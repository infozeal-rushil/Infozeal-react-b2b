...
const BlogItem = ({ blog }) => {
    return (<Card className="text-white h-100">
        ...
        <div className="d-flex align-items-center mb-3">
          <div className="d-flex align-items-center me-3">
            <Link to="#!" className="btn-link text-decoration-none d-flex align-items-center">
              <FontAwesomeIcon icon={faEye} className="text-body-quaternary me-1"/>
              <span className="text-body fs-10 lh-1">{blog.views}</span>
            </Link>
          </div>
          <div className="d-flex align-items-center me-3">
            <Link to="#!" className="btn-link text-decoration-none d-flex align-items-center">
              <FontAwesomeIcon icon={faHeart} className="text-body-quaternary me-1"/>
              <span className="text-body fs-10 lh-1">{blog.likes}</span>
            </Link>
          </div>
          <div className="d-flex align-items-center">
            <Link to="#!" className="btn-link text-decoration-none d-flex align-items-center">
              <FontAwesomeIcon icon={faComment} className="text-body-quaternary me-1"/>
