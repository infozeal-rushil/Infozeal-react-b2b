...
const FeatureSection = ({ feature, orderReverse }) => {
    const { lightImage, darkImage, label, title, details, link } = feature;
    return (<Row className="align-items-center justify-content-between text-center text-lg-start mb-6 mb-lg-2">
      <Col lg={5} className={classNames({
