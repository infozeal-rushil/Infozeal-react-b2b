...
import bg13 from '@src/assets/img/bg/bg-13.png';
import bgRight21 from '@src/assets/img/bg/bg-right-21.png';
import bgLeft21 from '@src/assets/img/bg/bg-left-21.png';
import capterra from '@src/assets/img/generic/capterra.png';
