...
const BoardViewItem = ({ project }) => {
    const [openDetailsModal, setOpenDetailsModal] = useState(false);
    return (<>
      <RevealDropdownTrigger className="position-relative rounded-2 overflow-hidden p-4 cursor-pointer" style={{ height: 236 }} onClick={() => setOpenDetailsModal(true)}>
        ...
        <div className="position-relative h-100 d-flex flex-column justify-content-between">
          <div className="d-flex justify-content-between align-items-center">
            <Badge variant="phoenix" bg={project.status.type} className="fs-10" data-bs-theme="light">
      ...
      <BoardViewModal show={openDetailsModal} handleClose={() => setOpenDetailsModal(false)} project={project}/>
    </>);
};
