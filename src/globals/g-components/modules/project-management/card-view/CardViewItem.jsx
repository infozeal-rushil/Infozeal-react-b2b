...
import { faChevronRight, faCreditCard, faListCheck, faUser } from '@fortawesome/free-solid-svg-icons';
const CardViewItem = ({ project }) => {
    ...
    return (<>
        ...
        <Card.Body>
          <div className="d-flex align-items-center">
            ...
            <div className="hover-actions top-0 end-0 mt-4 me-4">
              <Button variant="primary" className="btn-icon flex-shrink-0" onClick={() => setOpenDetailsModal(true)}>
          ...
          <div className="d-flex align-items-center mb-2">
            <FontAwesomeIcon icon={faUser} className="me-2 text-body-tertiary fs-9 fw-extra-bold"/>
          ...
          <div className="d-flex align-items-center mb-4">
            <FontAwesomeIcon icon={faCreditCard} className="me-2 text-body-tertiary fs-9 fw-extra-bold"/>
            <p className="fw-bold mb-0 text-truncate lh-1">
              Budget :{' '}
            ...
            <div className="d-flex d-lg-block d-xl-flex justify-content-between align-items-center mt-3">
              <div className="d-flex gap-1">
                <Avatar.Group total={project.assigness.length} size="m">
                  {project.assigness.slice(0, 4).map(assigne => (<AvatarDropdown user={assigne} size="m" key={assigne.id}/>))}
                </Avatar.Group>
              </div>
      ...
      <CardViewModal show={openDetailsModal} handleClose={() => setOpenDetailsModal(false)} project={project}/>
    </>);
};
