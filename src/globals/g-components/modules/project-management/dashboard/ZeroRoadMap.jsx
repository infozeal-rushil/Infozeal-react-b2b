...
const ZeroRoadMap = () => {
    ...
    return (<div className="gantt-zero-roadmap">
      <h3>Project: zero Roadmap</h3>
      <p className="text-body-tertiary">Phase 2 is now ongoing</p>
      <Row className="g-2 flex-between-center mb-3">
        <Col xs={12} sm="auto">
          <div className="d-flex gap-3">
            <Form.Check className="d-flex min-h-auto mb-0 align-items-end ps-0" id="progress">
              <Form.Check.Label className="mb-0 me-2 lh-1 text-body">
                Progress
              </Form.Check.Label>
              <Form.Check type="switch" checked={showProgress} className="mb-0" onChange={(e) => {
            setShowProgress(e.target.checked);
        }}/>
            </Form.Check>
            <Form.Check className="d-flex min-h-auto mb-0 align-items-end ps-0" id="links">
              <Form.Check.Label className="mb-0 me-2 lh-1 text-body">
                Links
              </Form.Check.Label>
              <Form.Check type="switch" checked={showLinks} className="mb-0" onChange={(e) => {
        ...
        <Col xs={12} sm="auto">
          <ButtonGroup>
            <CheckButton label="Week" id="week" inputProps={{
            name: 'scaleView',
            value: 'week',
            ...
            <CheckButton label="Month" id="month" inputProps={{
            name: 'scaleView',
            value: 'month',
            ...
            <CheckButton label="Year" id="year" inputProps={{
            name: 'scaleView',
            value: 'year',
