...
import { faChevronRight, faEarthAmericas, faListCheck, faUser } from '@fortawesome/free-solid-svg-icons';
    ...
    return (<>
          ...
          <tbody>
            ...
            <tr>
              <td className="align-top py-1">
                <div className="d-flex">
                  <FontAwesomeIcon icon={faUser} className="me-2 text-body-tertiary fs-9"/>
            ...
            <tr>
              <td className="align-top py-1">
                <div className="d-flex">
                  <FontAwesomeIcon icon={faCreditCard} className="me-2 text-body-tertiary fs-9"/>
      ...
      <div>
        <div className="d-flex align-items-center">
          <FontAwesomeIcon icon={faListCheck} className="me-2 text-body-tertiary fs-9"/>
