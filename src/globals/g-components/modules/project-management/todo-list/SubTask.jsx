...
const SubTask = ({ task, className }) => {
    return (<div className={classNames(className, 'd-flex flex-between-center hover-actions-trigger py-3 border-bottom')}>
      <Form.Check type="checkbox" id={snakeCase(task.task)} className="mb-1 mb-md-0 d-flex align-items-center lh-1 min-h-auto">
      ...
      <div className="hover-actions end-0">
        <Button variant="" size="sm" className="me-1 text-body-tertiary px-0 me-3">
