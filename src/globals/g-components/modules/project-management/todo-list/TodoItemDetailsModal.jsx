...
const TodoItemDetailsModal = ({ handleClose, item }) => {
    return (<Modal show={!!item} onHide={handleClose} size="xl">
      {item && (<>
          <Modal.Header className="px-6 py-5 pe-sm-5 px-md-6 dark__bg-gray-1100">
            ...
            <Button variant="phoenix-secondary" onClick={handleClose} className="btn-icon btn-icon-xl flex-shrink-0 ms-auto">
          ...
          <Modal.Body className="bg-body-highlight px-5 px-sm-6 py-0 rounded-bottom">
            ...
            ]} className="mb-5" isMulti placeholder="Select organizer" icon={<UilTagAlt className="react-select-icon text-body-tertiary" size={16}/>}/>
