...
import { attachments, subTasks } from 'data/project-management/todoListData';
...
const TodoItemDetailsOffcanvas = ({ handleClose, item }) => {
    return (<PhoenixOffcanvas open={!!item} onHide={handleClose} className="todolist-offcanvas" placement="end" fixed backdropClassName="opacity-0">
      {item && (<>
          <div className="p-5 p-md-6">
            <div className="d-flex flex-between-center mb-4 gap-3">
              ...
              <Button variant="phoenix-secondary" onClick={handleClose} className="btn-icon flex-shrink-0">
            ...
            <div className="mb-6">
              ...
              <div className="mb-3">
                {subTasks.map((subTask, index) => (<SubTask key={subTask.task} task={subTask} className={classNames({
            ...
            <div className="mb-6">
              ...
              <div className="mx-n5 mx-md-n6 mb-3">
                {attachments.map((attachment, index) => (<FileListItem key={attachment.name} attachment={attachment} className={classNames('px-5 px-md-6', {
                    'border-top border-translucent': index === 0
                })}/>))}
              </div>
              <div className="">
            ...
            <div className="mb-4">
              ...
              <div className="mb-4">
                ...
                enableTime: true,
                dateFormat: 'H:i'
            }} icon={<UilBellSchool className="flatpickr-icon text-body-tertiary" size={16}/>}/>
              </div>
              <h5 className="text-body-highlight mb-2">Tag</h5>
              <ReactSelect menuPlacement="top" options={[
                {
            ...
            ]} className="mb-6" isMulti placeholder="Select organizer" icon={<UilTagAlt className="react-select-icon text-body-tertiary" size={16}/>}/>
