...
import thumbsUpIcon from '@src/assets/img/icons/thumbs-up.png';
import bg26 from '@src/assets/img/bg/26.png';
import section63 from '@src/assets/img/sections/63.webp';
