...
import { faCircle, faComment, faEarthAmericas, faHeart, faShare } from '@fortawesome/free-solid-svg-icons';
const PostCard = ({ post }) => {
      ...
      <Card className="mb-4 overflow-hidden">
        <Card.Body className="p-3 p-sm-4">
            ...
            <div className="d-flex align-items-center mb-3">
              ...
              <div className="flex-1">
                ...
                <p className="fs-10 mb-0 text-body-tertiary text-opacity-85 fw-semibold">
                  {post.time}
                  {post.location && (<>
                      <FontAwesomeIcon icon={faCircle} className="text-light" transform="shrink-10 down-2"/>
                      {post.location}
                      <FontAwesomeIcon icon={faCircle} className="text-light" transform="shrink-10 down-2"/>
                      <FontAwesomeIcon icon={faEarthAmericas} className="text-body"/>
                    </>)}
                </p>
              </div>
          ...
          <div className="d-flex">
            <Button variant="link" startIcon={<FontAwesomeIcon icon={faHeart}/>} className="p-0 me-3 fs-10 fw-bolder">
              {post.interactions.likes} Likes
            </Button>
            <Button variant="link" startIcon={<FontAwesomeIcon icon={faComment}/>} className="p-0 me-3 fs-10 fw-bolder text-body">
              {post.interactions.comments} Comments
            </Button>
            <Button variant="link" startIcon={<FontAwesomeIcon icon={faShare}/>} className="p-0 me-3 fs-10 fw-bolder text-body">
