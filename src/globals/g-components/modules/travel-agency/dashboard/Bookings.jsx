...
const Bookings = () => {
    ...
    return (<Card className="h-100">
      <Card.Header className="pb-3 d-sm-flex d-xl-block d-xxl-flex justify-content-between align-items-start">
        ...
        <Form.Select size="sm" className="pe-9 w-auto mt-3 mt-sm-0 mt-xl-3 mt-xxl-0" value={selectedOption} onChange={e => setSelectedOption(parseInt(e.target.value))}>
      ...
      <Card.Body>
        <BookingsChart ref={chartRef} style={{ height: '100%', minHeight: 322, width: '100%' }}/>
      </Card.Body>
    </Card>);
};
