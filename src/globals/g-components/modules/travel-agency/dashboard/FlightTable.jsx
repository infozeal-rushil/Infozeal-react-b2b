        ...
        <div className="d-flex align-items-center gap-2 mt-3">
          ...
          <div className="position-relative w-100">
            <ProgressBar style={{ height: 2 }} className="overflow-visible align-middle">
              <ProgressBar now={50} min={0} max={100} variant="info" style={{
            height: '2px',
            transform: 'translateY(-75%)'
        }}/>
            </ProgressBar>
            <FontAwesomeIcon className="text-info position-absolute top-50 translate-middle-y" icon={faPlane} style={{ left: '50%' }} // Adjust this to match current progress
    />
          </div>
