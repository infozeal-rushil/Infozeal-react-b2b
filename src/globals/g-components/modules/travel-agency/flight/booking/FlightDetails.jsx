...
import { faSuitcaseRolling, faBriefcase } from '@fortawesome/free-solid-svg-icons';
const BaggageRow = ({ icon, label, weight }) => (<tr>
        ...
        <Col lg={3} className="border-end-lg mb-5 mb-lg-0">
          ...
          <Table borderless className="mb-0" style={{ maxWidth: '9.375rem' }}>
            <tbody>
              ...
              <BaggageRow icon={faSuitcaseRolling} label="Cargo" weight="20 kgs"/>
