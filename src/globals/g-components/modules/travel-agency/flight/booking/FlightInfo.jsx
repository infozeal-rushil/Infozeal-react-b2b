...
import longArrowDown from '@src/assets/img/icons/long-arrow-down.svg';
import qatarAirlineLogo from '@src/assets/img/brand/qatar-airline.png';
const FlightDetails = ({ time, date, airportCode, airportName }) => (
