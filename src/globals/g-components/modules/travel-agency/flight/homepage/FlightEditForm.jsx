...
const FlightEditForm = ({ formData, setFormData }) => {
    ...
    const priceRangeChangeHandler = (val) => {
        setFormData(prev => (Object.assign(Object.assign({}, prev), { priceRange: val })));
    };
    return (<Row className="g-3">
      <Col md={4} lg xl={2}>
        <h5 className="text-body-emphasis mb-2">Fare Type</h5>
        <Form.Check type="checkbox" id="flightFareType" className="mb-0">
          <Form.Check.Input type="checkbox" name="flightFareType" checked={formData.flightFareType} onChange={onchangeHandler} className="mt-0"/>
      ...
      <Col md={4} lg xl={2}>
        ...
        <PhoenixReactRange values={formData.priceRange} variant="primary-lighter" min={100} max={200} trackHeight={'4px'} classNames={'phoenix-react-range-slim px-2 pt-1 mb-3'} onChange={val => priceRangeChangeHandler(val)}/>
      ...
      <Col md={4} lg xl={2}>
        ...
        <Form.Select id="flightClass" name="flightClass" onChange={onchangeHandler}>
      ...
      <Col md={6} lg xl={2} className="ms-lg-auto">
        ...
        <Form.Select id="departTime" name="departTime" onChange={onchangeHandler}>
      ...
      <Col md={6} lg xl={2}>
        ...
        <Form.Select id="returnTime" name="returnTime" onChange={onchangeHandler}>
          <option value="12:00 - 18:00">12:00 - 18:00</option>
          <option value="18:00 - 24:00">18:00 - 24:00</option>
          <option value="06:00 - 12:00">06:00 - 12:00</option>
        </Form.Select>
