...
import qutarAirline from '@src/assets/img/brand/qatar-airline.png';
import emiratesAirline from '@src/assets/img/brand/emirates-airline.png';
import japanAirline from '@src/assets/img/brand/japan-airline.png';
import longArrow from '@src/assets/img/icons/long-arrow.svg';
...
const FlightItem = ({ airline, schedules, price }) => {
  return (
