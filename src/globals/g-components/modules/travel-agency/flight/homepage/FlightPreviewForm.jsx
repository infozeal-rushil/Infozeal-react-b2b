...
const FlightPreviewForm = ({ formData }) => {
    return (<Row className="g-3">
      <Col md={4} lg xl={2}>
        <h5 className="text-body-emphasis mb-2">Fare Type</h5>
        <div className="d-flex align-items-center">
          <FontAwesomeIcon icon={faTicket} className="text-body me-2" transform="up-1"/>
      ...
      <Col md={4} lg xl={2}>
        ...
        <div className="d-flex align-items-center">
          <FontAwesomeIcon icon={faTag} className="text-body me-2" transform="up-1"/>
          <p className="text-body text-nowrap mb-0">
      ...
      <Col md={4} lg xl={2}>
        ...
        <div className="d-flex align-items-center">
          <FontAwesomeIcon icon={faCouch} className="text-body me-2" transform="up-1"/>
