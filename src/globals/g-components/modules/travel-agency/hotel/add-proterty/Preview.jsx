...
import infoDark from '@src/assets/img/icons/info_dark.svg';
import locationImg from '@src/assets/img/icons/location.svg';
import locationDark from '@src/assets/img/icons/location_dark.svg';
import bedDouble from '@src/assets/img/icons/bed-double.svg';
import bedDoubleDark from '@src/assets/img/icons/bed-double_dark.svg';
import picture from '@src/assets/img/icons/picture.svg';
import pictureDark from '@src/assets/img/icons/picture_dark.svg';
import dollarAlt from '@src/assets/img/icons/dollar-alt.svg';
import dollarAltDark from '@src/assets/img/icons/dollar-alt_dark.svg';
import fileCheckAlt from '@src/assets/img/icons/file-check-alt.svg';
import fileCheckAltDark from '@src/assets/img/icons/file-check-alt_dark.svg';
      ...
      data: [
        {
          ...
          value: `${
            (_a = formData.ageSegment1) === null || _a === void 0
              ? void 0
              : _a.join(' - ')
          } years`
        },
        {
          ...
          value: `${
            (_b = formData.ageSegment2) === null || _b === void 0
              ? void 0
              : _b.join(' - ')
          } years`
        },
        {
          ...
          value: `${
            (_c = formData.ageSegment3) === null || _c === void 0
              ? void 0
              : _c.join(' - ')
          } years`
        },
          ...
          <Row className="g-2 g-sm-3">
            {(_d =
              formData === null || formData === void 0
                ? void 0
                : formData.photos) === null || _d === void 0
              ? void 0
              : _d.map((item, index) => (
