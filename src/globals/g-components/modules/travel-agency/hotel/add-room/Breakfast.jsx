...
const Breakfast = () => {
    ...
    return (<>
      ...
      <Form.Group className="mb-2">
        <Form.Check type="radio" label="Yes, it's included in the price" id="breakfastIncluded" value="breakfastIncluded" name="breakfastRadio" inline onClick={() => setOpen(true)} defaultChecked/>
        <Form.Check inline type="radio" id="breakfastNotIncluded" value="breakfastNotIncluded" label="No" name="breakfastRadio" onClick={() => setOpen(false)}/>
      </Form.Group>
      <Collapse in={open} className="w-sm-60">
        <div>
          ...
          <FloatingLabel controlId="breakfastType2" className="my-2" label="option 2">
            <Form.Select>
