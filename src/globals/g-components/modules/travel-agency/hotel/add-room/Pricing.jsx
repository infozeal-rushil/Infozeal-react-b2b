    ...
    return (<>
      ...
      <Tab.Container activeKey={selectedTab}>
        <Form.Group className="mb-2">
          <Form.Check type="radio" label="Across all days" id="allDayPricing" value="allDayPricing" name="isAllDayPricing" inline checked={selectedTab === 'allDayPricing'} onChange={e => setSelectedTab(e.target.value)}/>
          <Form.Check inline type="radio" id="weeklyPricing" value="weeklyPricing" label="By day of week" name="isAllDayPricing" checked={selectedTab === 'weeklyPricing'} onChange={e => setSelectedTab(e.target.value)}/>
        </Form.Group>
        <Tab.Content>
            ...
            <Row className="gx-2 w-sm-60">
              <Col xs={8}>
                <FloatingLabel controlId="roomPrice" label="Room Price">
                  <Form.Control type="number" placeholder="" name="roomPrice" onChange={onChange} className="input-spin-none"/>
                </FloatingLabel>
              </Col>
              <Col xs={4}>
      ...
      <>
        ...
        <FloatingLabel controlId="peopleSelect" label="Select" className="w-sm-60">
