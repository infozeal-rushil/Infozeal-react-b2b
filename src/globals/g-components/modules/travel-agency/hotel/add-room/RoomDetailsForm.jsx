...
const CounterFormGroup = ({ id, label }) => (<Form.Group controlId={id}>
      ...
      <Row className="g-3 g-sm-4 mb-6">
        ...
        <Col sm={6} md={5}>
          <Form.Group controlId="roomName">
            ...
            <Form.Control type="text" placeholder="Enter name" onChange={onChange} name="roomName"/>
          </Form.Group>
        </Col>
      </Row>
      ...
      <Row className="gx-3 gx-sm-4 gy-3 mb-6">
        ...
        <Col xs={6}>
          <Form.Group controlId="roomSize">
            ...
            <InputGroup>
              <FormControl type="number" placeholder="Size" className="input-spin-none" onChange={onChange}/>
              <Form.Select onChange={onChange} style={{ minWidth: 100, flex: 'unset' }}>
