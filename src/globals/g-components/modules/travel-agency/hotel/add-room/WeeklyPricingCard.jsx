...
const WeeklyPricingCard = () => {
    ...
    return (<Card className="bg-body-highlight">
      <Card.Body>
        ...
        <hr className="mb-2"/>
        <Row className="g-2">
          {days.map((item, index) => (<Col xs={4} sm key={index}>
              <Form.Group controlId="weeklyPricingUsd">
                <Form.Label className="form-label-header mb-1 fs-9">
                  {item}
                </Form.Label>
                <Form.Control type="number" className="input-spin-none" onChange={onChange} defaultValue={100}/>
              </Form.Group>
            </Col>))}
        </Row>
      </Card.Body>
