...
const HotelDetailsDescription = ({ activeKey }) => {
        ...
        <Card.Body>
          <div className="mb-4">
            <Suspense fallback={<PhoenixLoader />}>
              <Mapbox ref={mapRef} className="rounded-2 border border-translucent overflow-hidden w-100" style={{ height: 300 }} options={{
          ...
          <p className="mb-2 text-body-tertiary text-uppercase">
            <FontAwesomeIcon icon={faMapMarkerAlt} className="text-body-emphasis me-2"/>
            Museum
          </p>
          <h5>
