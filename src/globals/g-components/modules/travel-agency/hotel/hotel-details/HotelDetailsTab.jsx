...
import { availableRooms, facilities, charges, ratings, reviews } from 'data/travel-agency/customer/hotelDetails';
const generateTabItems = (activeKey) => [
    {
        name: 'Availability',
    ...
    {
        name: 'Facilities',
        content: (<HotelDetailsFacilities facilities={facilities} charges={charges}/>)
    },
    {
        name: 'Reviews',
...
const HotelDetailsTab = () => {
    ...
    return (<Tab.Container activeKey={activeKey} onSelect={handleSelect} mountOnEnter={false}>
