...
const TripDetailsTabDetailsExpectation = ({ expectations }) => {
    return (<div className="py-6 px-4">
      {expectations.map((expectation, index) => (<div key={expectation.id} className={classNames({
                'mb-5': expectations.length - 1 !== index
            })}>
          <div className="d-flex align-items-center gap-2">
            <span className="bg-secondary rounded-pill d-flex flex-center text-white" style={{ width: 27, height: 27 }}>
              {index + 1}
            </span>
          ...
          <div className="d-flex gap-3 gap-xl-4 flex-wrap">
            ...
            <h5 className="text-body-highlight fw-semibold mb-0">
              <FontAwesomeIcon icon={faLocationDot} className="text-body-quaternary me-2"/>
              Location :{' '}
              <span className="text-body-tertiary fw-normal">
