...
const TripDetailsTabReviewAllReviews = ({ overallReview }) => {
    return (<Row className="gy-5 align-items-center">
      <Col xl={5} xxl={4}>
        <div className="d-flex align-items-center gap-3 flex-wrap">
          ...
          <Badge variant="phoenix" bg="success" className="border-0 px-3 py-2 fs-8 text-capitalize">
      ...
      <Col xl={7} xxl={8}>
        <div className="d-flex gap-5 gap-md-6 gap-xl-8 gap-xxl-6 flex-wrap">
          {overallReview.reviewStates.map((statItem, index) => (<div key={statItem.id} className={classNames('d-lg-flex d-xl-block d-xxl-flex align-items-center gap-3', {
                'ms-xl-auto': index === 0
            })}>
              <div className="order-lg-1 order-xl-0 order-xxl-1">
                <TripDetailsReviewChart stat={statItem.count} className="mx-auto"/>
              </div>
