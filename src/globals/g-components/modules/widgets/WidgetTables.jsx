...
const WidgetTables = () => {
    ...
    return (<div>
      <WidgetsSectionTitle title="Tables, Files, and Lists" subtitle="Phoenix's styled components are dedicatedly made for displaying your contents and lists." icon={faList} className="mb-5 mt-7"/>
