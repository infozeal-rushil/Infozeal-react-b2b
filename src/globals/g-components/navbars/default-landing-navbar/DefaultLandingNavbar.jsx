...
const NavItem = ({ label, url, isLast }) => {
    return (<Nav.Item as="li" className={classNames({
...
const DefaultLandingNavbar = ({ className }) => {
    ...
    return (<>
      <div className={classNames(className, 'bg-body-emphasis sticky-top landing-navbar')} ref={containerRef}>
        <Navbar className="px-3 px-lg-7 px-xxl-3 container-small" expand="lg">
          <Navbar.Brand as={Link} to="/" className="text-decoration-none flex-1 flex-lg-grow-0">
            <Logo />
          </Navbar.Brand>
          ...
          <Navbar.Collapse>
            <div className="border-bottom border-translucent d-lg-none mb-2">
              <SearchBox placeholder="Search" className="w-100" inputClassName="rounded-pill my-4"/>
            </div>
            ...
            <div className="d-grid d-lg-flex gap-4 align-items-center">
              ...
              <Button className="p-0 text-body-tertiary text-body-emphasis-hover d-none d-lg-inline lh-sm" onClick={() => setOpenSearchModal(!openSearchModal)}>
                <FeatherIcon icon="search" size={20}/>
              </Button>
              <Link to="#!" className="btn btn-link p-0 text-body order-1 order-lg-0">
                Sign in
              </Link>
      ...
      <Modal show={openSearchModal} onHide={() => setOpenSearchModal(false)} className="search-box-modal mt-15">
        <Modal.Body className="p-0 bg-transparent">
          <DropdownSearchBox size="lg" className="navbar-top-search-box" inputClassName="rounded-pill" style={{ width: 'auto' }}>
            <SearchResult />
          </DropdownSearchBox>
        </Modal.Body>
      </Modal>
