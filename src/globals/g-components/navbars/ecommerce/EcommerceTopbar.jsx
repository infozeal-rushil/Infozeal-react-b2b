          ...
          <Row className="gx-0 gy-2 w-100 flex-between-center">
            ...
            <Col xs="auto" className="order-md-1">
              <Nav as="ul" className="navbar-nav-icons flex-row me-n2">
                ...
                <Nav.Item as="li">
                  <Nav.Link as={Link} to="/apps/e-commerce/customer/cart" className="px-2 icon-indicator icon-indicator-primary">
                ...
                <Nav.Item as="li">
                  <Dropdown autoClose="outside">
                    <Dropdown.Toggle as={Link} to="#!" className="dropdown-caret-none nav-link icon-indicator icon-indicator-sm icon-indicator-danger" variant="">
                ...
                <Nav.Item as="li">
                  <Dropdown autoClose="outside">
                    <Dropdown.Toggle as={Link} to="#!" className="dropdown-caret-none nav-link lh-1" variant="">
            ...
            <Col xs={12} md={6}>
              <SearchBox placeholder="Search..." className="ecommerce-search-box w-100" inputClassName="rounded-pill" size="sm"/>
            </Col>
          </Row>
        </Navbar>
      </div>
