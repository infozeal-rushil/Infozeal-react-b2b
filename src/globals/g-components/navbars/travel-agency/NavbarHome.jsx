import { faHotel, faPlane, faSuitcaseRolling } from '@fortawesome/free-solid-svg-icons';
...
const NavbarHome = ({ currentPage }) => {
    return (<>
      <Nav className="nav-home justify-content-center py-4 gap-2">
        {nav.map((item, index) => (<Nav.Item key={index}>
            <Nav.Link as={Link} className={classNames('fw-bold rounded-3', {
