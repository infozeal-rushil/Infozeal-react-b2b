...
const DealForecasrProgressBar = () => {
    return (<div className="w-100">
      ...
      <ProgressBar className="mb-3 rounded-3" style={{ height: '10px' }}>
        <ProgressBar className="border-end bg-primary-dark border-2" now={20.72} key={1}/>
        <ProgressBar className="bg-primary-light border-end border-2" now={35.76} key={2}/>
        <ProgressBar className="bg-success border-end border-2" now={25.38} key={3}/>
