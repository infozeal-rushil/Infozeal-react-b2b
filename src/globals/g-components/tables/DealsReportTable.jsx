...
import { currencyFormat, getColor, getProgressColorVariant } from 'helpers/utils';
...
export const dealsReportColumns = [
    {
        accessorKey: 'dealName',
        header: 'Deal Name',
        cell: ({ row: { original } }) => (<Link to="#!" className="fw-bold text-primary">
        {original.dealName}
      </Link>),
        meta: {
            headerProps: {
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to={profileLink} className="d-flex align-items-center text-body">
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
          ...
          <div style={{ '--phoenix-circle-progress-bar': value }}>
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
          ...
          <FeatherIcon icon={`trending-${trending}`} size={14} className={classNames('ms-2', {
