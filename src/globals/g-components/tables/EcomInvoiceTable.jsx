...
const EcomInvoiceTable = () => {
    return (<Scrollbar autoHeight autoHeightMax="100%">
      <table className="table fs-9 text-body mb-0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="align-middle text-end fw-semibold text-danger" colSpan={2}>
              -$50
            </td>
            <td />
          </tr>
          <tr className="bg-body-secondary">
            <td className="align-middle ps-4 fw-bold text-body-highlight" colSpan={3}>
              Grand Total
            </td>
            <td className="align-middle fw-bold text-body-highlight" colSpan={7}>
