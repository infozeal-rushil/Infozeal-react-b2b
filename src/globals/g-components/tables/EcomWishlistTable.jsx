...
const columns = [
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<div className="rounded-2 border border-translucent d-inline-block">
    ...
    {
        id: 'action',
        cell: () => (<div className="d-flex gap-2 justify-content-end">
        <Button size="sm" className="text-body-quaternary text-body-tertiary-hover">
          <FontAwesomeIcon icon={faTrash}/>
        </Button>
        <Button variant="primary" className="fs-10 text-nowrap" startIcon={<FontAwesomeIcon icon={faShoppingCart}/>}>
          Add to cart
        </Button>
      </div>),
        meta: {
