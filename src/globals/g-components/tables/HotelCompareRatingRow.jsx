...
const HotelCompareRatingRow = ({ title, ratingValues }) => {
    return (<tr>
      ...
      {ratingValues.map((value, index) => (<td className="px-3 border-end border-translucent" key={index}>
          <div className="d-flex align-items-center gap-2">
            ...
            <ProgressBar now={parseFloat(value.toString()) * 20} style={{ height: 8 }} className="bg-body-highlight w-100"/>
          </div>
        </td>))}
    </tr>);
};
