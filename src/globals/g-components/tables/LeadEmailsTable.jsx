...
export const leadEmailsColumns = [
    {
        header: 'Subject',
    ...
    },
    {
        ...
        cell: ({ row: { original: { status } } }) => (<Badge variant="phoenix" bg={getBadgeBg(status.label)}>
        {status.label}
      </Badge>),
        meta: {
            headerProps: {
...
const LeadEmailsTable = () => {
    return (<div className="border-y border-translucent">
