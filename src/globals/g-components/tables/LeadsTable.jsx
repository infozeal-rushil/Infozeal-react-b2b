...
export const leadsTableColumns = [
    {
        ...
        header: 'Name',
        cell: ({ row: { original } }) => {
            const { avatar, name, designation, status: { label, type } } = original.customer;
    ...
    },
    {
        accessorKey: 'email',
        header: () => {
            return (<div className="d-inline-flex flex-center">
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link className="text-body-highlight" to={`mailto:${email}`}>
          {email}
        </Link>);
        },
        meta: {
            ...
            cellProps: {
                className: 'white-space-nowrap fw-semibold ps-4 border-end border-translucent'
            }
        }
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link className="text-body-highlight" to={`tel:${phone}`}>
          {phone}
        </Link>);
        },
        meta: {
    ...
    },
    {
        ...
        meta: {
            ...
            cellProps: {
                className: 'white-space-nowrap ps-4 border-end border-translucent fw-semibold text-body-highlight'
            }
        }
    },
    {
...
const LeadsTable = () => {
    return (<div className="border-top border-translucent">
      <AdvanceTable tableProps={{ className: 'phoenix-table fs-9' }} rowClassName="hover-actions-trigger btn-reveal-trigger"/>
