...
export const membersTablecolumns = [
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to="#!" className=" d-flex align-items-center text-body">
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to={`mailto:${email}`} className="fw-semibold">
          {email}
        </Link>);
        },
        meta: {
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to={`tel:${mobile}`} className="fw-bold text-body-emphasis">
          {mobile}
        </Link>);
        },
        meta: {
