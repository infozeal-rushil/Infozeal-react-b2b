...
export const ordersTableColumns = [
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to="#!" className="fw-semibold">
          #{orderId}
        </Link>);
        },
        meta: {
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to="/apps/e-commerce/admin/customer-details" className="d-flex align-items-center">
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Badge bg={payment_status.type} variant="phoenix" iconPosition="end" className="fs-10" icon={<FeatherIcon icon={payment_status.icon} size={12.8} className="ms-1"/>}>
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Badge bg={fulfilment_status.type} variant="phoenix" iconPosition="end" className="fs-10" icon={<FeatherIcon icon={fulfilment_status.icon} size={12.8} className="ms-1"/>}>
