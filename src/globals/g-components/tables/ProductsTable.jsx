...
export const productsTablecolumns = [
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to="/apps/e-commerce/customer/product-details" className="rounded-2 border border-translucent d-inline-block">
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to="/apps/e-commerce/customer/product-details" className="fw-semibold line-clamp-3">
          {product}
        </Link>);
        },
        meta: {
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
          ...
          {tags.map(tag => (<Link key={tag} to="#!" className="text-decoration-none">
