...
export const projectListTableColumns = [
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Avatar.Group total={assigness.length} size="s">
          {assigness.slice(0, 4).map(assigne => (<Avatar key={assigne.id} src={assigne.avatar ? assigne.avatar : undefined} variant={assigne.avatar ? 'image' : 'name'} size="s">
...
const ProjectListTable = () => {
    return (<div className="border-bottom border-translucent">
