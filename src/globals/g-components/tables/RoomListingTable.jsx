...
import { faBaby, faBath, faBed, faBorderAll, faFileExport, faFilter, faPersonShelter, faPlus, faUser } from '@fortawesome/free-solid-svg-icons';
...
import { RoomListingData } from 'data/travel-agency/roomListing';
const columns = [
    {
        id: 'roomInformation',
        ...
        cell: ({ row: { original } }) => {
          ...
          <div className="d-flex align-items-center gap-3">
            <Link to="#!">
              <img src={img} alt="" width={80} className="rounded-1 border border-translucent"/>
            </Link>
            <div>
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
          ...
          <div className="d-flex align-items-center justify-content-center bg-primary-subtle rounded me-2" style={{ height: 24, width: 24 }}>
            <FontAwesomeIcon icon={faPersonShelter} className="text-primary-darker"/>
          </div>
          <h5 className="text-body-emphasis fw-semibold mb-0 me-3">
            {bedRooms}
          </h5>
          <div className="d-flex align-items-center justify-content-center bg-success-subtle rounded me-2" style={{ height: 24, width: 24 }}>
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<div className="d-flex align-items-center">
          <div className="d-flex align-items-center justify-content-center bg-warning-subtle rounded me-2" style={{ height: 24, width: 24 }}>
            <FontAwesomeIcon icon={faUser} className="text-warning-darker"/>
          </div>
          <h5 className="text-body-emphasis fw-semibold mb-0 me-3">{guest}</h5>
          <div className="d-flex align-items-center justify-content-center bg-info-subtle rounded me-2" style={{ height: 24, width: 24 }}>
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<div className="d-flex align-items-center">
          <div className="d-flex align-items-center justify-content-center bg-danger-subtle rounded me-2" style={{ height: 24, width: 24 }}>
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
          ...
          {amenities.slice(0, 13).map((item, index) => (<Badge key={index} variant="phoenix" bg="primary" className="text-body-highlight py-1 fs-10 border-0">
              {item}
            </Badge>))}
          {amenities.length > 13 && (<Link to="#!" className="fw-bold fs-9">
...
const RoomListingTable = () => {
    ...
    return (<AdvanceTableProvider {...table}>
      <div className="d-md-flex mt-5 mb-4">
        <Button variant="primary" startIcon={<FontAwesomeIcon icon={faPlus} className="me-2"/>} className="me-4">
          Create Listing
        </Button>
        <Button variant="link" startIcon={<FontAwesomeIcon icon={faFileExport} className="me-2 fs-9"/>} className="text-body me-4 px-0">
          Export
        </Button>
