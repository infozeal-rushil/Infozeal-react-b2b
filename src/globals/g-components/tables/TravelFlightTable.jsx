...
import { faArrowRight, faFilter, faPlane, faTemperature0 } from '@fortawesome/free-solid-svg-icons';
...
import { flightsData } from 'data/travel-agency/travelAgency';
...
const columns = [
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to="#!" className="fw-bold">
          {flightNo}
        </Link>);
        },
        meta: {
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Link to="#!" className="d-flex align-items-center gap-2">
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
          ...
          <FontAwesomeIcon icon={faTemperature0} className={`me-2 text-${weather.temperature > 25 ? 'danger' : 'info'}`}/>
          <p className="mb-0 text-body-tertiary me-3">
            {weather.temperature}°C
          </p>
          <FontAwesomeIcon icon={weather.icon} className={`me-2 ${weather.color}`}/>
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
          ...
          <FontAwesomeIcon icon={faArrowRight} className="text-body-tertiary mx-1"/>
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
          ...
          <div className="position-relative">
            <ProgressBar style={{ height: 2 }} className="overflow-visible align-middle">
              <ProgressBar now={destination.percent} min={0} max={100} variant="info-light"/>
            </ProgressBar>
            <FontAwesomeIcon className={classNames('text-info plane-icon position-absolute top-50 translate-middle-y', {
                    'd-none': status.label.toLowerCase() === 'cancelled'
                })} icon={faPlane} style={{ left: `${destination.percent}%` }} // move along the progress bar
            />
          </div>

          <div className="d-flex justify-content-between mt-2">
            <p className={` mb-0 fs-10 ${status.label === 'Cancelled'
    ...
    },
    {
        ...
        cell: ({ row: { original } }) => {
            ...
            return (<Badge variant="phoenix" bg="primary" className={`badge-phoenix-${status.type}`}>
          {status.label}
        </Badge>);
        },
        meta: {
    ...
    },
    {
        ...
        header: '',
        cell: () => {
            return (<div className="btn-reveal-trigger">
      ...
      <Row className="gx-0 gy-3 align-items-center py-4">
        <Col xl="auto" className="d-sm-flex flex-between-center">
          ...
          <div className="d-flex align-items-center">
            <SearchBox placeholder="Search by Flight no." className="ms-xl-6 w-100" onChange={handleSearchInputChange}/>
            <Button variant="phoenix-secondary" className="px-3 ms-2 me-3">
              <FontAwesomeIcon icon={faFilter} transform="down-2" className="text-body-secondary"/>
            </Button>
          </div>
        </Col>
