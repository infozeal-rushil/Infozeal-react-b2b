...
const columns = [
    {
        ...
        cell: ({ row: { original } }) => (<Link className="d-flex align-items-center text-primary py-md-1 py-xxl-0" to="#!">
    ...
    {
        accessorKey: 'status',
        cell: ({ row: { original } }) => (<Badge className="fs-10" variant="phoenix" bg={original.status.type}>
...
export const VisitorsTable = () => {
    ...
    return (<AdvanceTableProvider {...table}>
      ...
      <AdvanceTableFooter className="pt-3 pb-4" tableInfo="fs-8" viewAllBtnClass="ms-auto"/>
