...
const NavItem = ({ item, isLast }) => {
    return (<Nav.Link eventKey={item.eventKey} className={classNames('text-center text-sm-start cursor-pointer outline-none d-sm-flex align-items-sm-center', {
...
const InventoryTab = () => {
    return (<Tab.Container id="left-tabs-example" defaultActiveKey="pricing">
      <Row className="g-0 border-top border-bottom">
        <Col xs={12} sm={4}>
          <Nav className="flex-sm-column border-bottom border-bottom-sm-0 border-end-sm fs-9 vertical-tab h-100 justify-content-between">
            {navItems.map((item, index) => (<NavItem key={item.label} item={item} isLast={index === navItems.length - 1}/>))}
          </Nav>
        </Col>
          ...
          <Tab.Content className="py-3 ps-sm-4 h-100">
              ...
              <div className="d-flex flex-column h-100">
                ...
                <div className="flex-1 mb-4">
                  <div className="d-flex gap-3">
                    <Form.Control type="number" placeholder="Quantity" style={{ maxWidth: 385 }} className="input-spin-none"/>
                    <Button variant="primary" type="button" startIcon={<FontAwesomeIcon icon={faCheck}/>} className="text-nowrap">
                      Confirm
                    </Button>
                  </div>
                </div>
                    ...
                    <tr>
                      ...
                      <td className="text-body-tertiary fw-semibold py-1">
                        ...
                        <Button className="p-0 ms-1" type="button">
                          <FontAwesomeIcon icon={faRotate} className="text-body" style={{ '--phoenix-text-opacity': 0.6 }}/>
                        </Button>
                      </td>
                    </tr>
                    <tr>
            ...
            <Tab.Pane eventKey="attributes" className="h-100">
              ...
              <Form.Check type="checkbox" id="frozenProduct" className="mb-3">
                ...
                <Form.Control type="text" placeholder="Max. allowed Temperature" style={{ maxWidth: 350 }}/>
              </Form.Check>
