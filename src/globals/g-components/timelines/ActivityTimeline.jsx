...
const ActivityTimeline = ({ data }) => {
    return (<Timeline variant="vertical">
      {data.map((item, index) => (<Timeline.Item className="position-relative" key={item.id}>
          <Row className="g-md-3">
            <Col xs={12} md="auto" className="d-flex">
              ...
              <Timeline.Separator className="position-md-relative">
                <Timeline.Dot className="bg-primary-subtle">
                  <FontAwesomeIcon icon={item.separator.icon} className="text-primary-dark fs-10"/>
                </Timeline.Dot>
            ...
            <Col>
              <Timeline.Content>
                ...
                <p className={classNames('fs-9 text-body-secondary', {
