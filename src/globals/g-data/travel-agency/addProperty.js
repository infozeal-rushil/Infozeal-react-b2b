...
import gallery59 from '@src/assets/img/gallery/59.png';
import gallery60 from '@src/assets/img/gallery/60.png';
import gallery61 from '@src/assets/img/gallery/61.png';
import gallery62 from '@src/assets/img/gallery/62.png';
import gallery63 from '@src/assets/img/gallery/63.png';
export const pictures = [gallery59, gallery60, gallery61, gallery62, gallery63];
export const addPropertyDefaultFormData = {
