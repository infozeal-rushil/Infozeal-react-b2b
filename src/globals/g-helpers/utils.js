...
export const numberFormat = (number, notation = 'standard', options = {}) =>
  new Intl.NumberFormat('en-US', Object.assign({ notation }, options)).format(
    number
  );
/* Get Random Number */
...
export const transformTSCode = (snippet, target = ts.ScriptTarget.ES2015) =>
  transpile(snippet, {
